...
/**
 * Class _TurbineUser was generated by Cayenne. It is probably a good idea to
...
public class _TurbineUser extends org.apache.cayenne.CayenneDataObject {
  ...
  public static final String HAS_PHOTO_SMARTPHONE_PROPERTY =
    "hasPhotoSmartphone";
  ...
  public static final String PHOTO_MODIFIED_SMARTPHONE_PROPERTY =
    "photoSmartphoneModified";
  ...
  public static final String EIP_TACL_USER_ROLE_MAPS_PROPERTY =
    "eipTAclUserRoleMaps";
  ...
  public static final String EIP_TMSGBOARD_CATEGORY_PROPERTY =
    "eipTMsgboardCategory";
  ...
  public static final String EIP_TWORKFLOW_REQUEST_PROPERTY =
    "eipTWorkflowRequest";

  public static final String TURBINE_USER_GROUP_ROLE_PROPERTY =
  ...
  public void setPhotoModifiedSmartphone(
      java.util.Date photoModifiedSmartphone) {
  ...
  public void setEipMUserPosition(
      com.aimluck.eip.cayenne.om.account.EipMUserPosition eipMUserPosition) {
  ...
  public com.aimluck.eip.cayenne.om.account.EipMUserPosition getEipMUserPosition() {
    return (com.aimluck.eip.cayenne.om.account.EipMUserPosition) readProperty(
      "eipMUserPosition");
  }

  public void addToEipTAclUserRoleMaps(
      com.aimluck.eip.cayenne.om.account.EipTAclUserRoleMap obj) {
    addToManyTarget("eipTAclUserRoleMaps", obj, true);
  }

  public void removeFromEipTAclUserRoleMaps(
      com.aimluck.eip.cayenne.om.account.EipTAclUserRoleMap obj) {
  ...
  public void addToEipTCabinetFile(
      com.aimluck.eip.cayenne.om.portlet.EipTCabinetFile obj) {
    addToManyTarget("eipTCabinetFile", obj, true);
  }

  public void removeFromEipTCabinetFile(
      com.aimluck.eip.cayenne.om.portlet.EipTCabinetFile obj) {
  ...
  public void addToEipTEventlog(
      com.aimluck.eip.cayenne.om.portlet.EipTEventlog obj) {
    addToManyTarget("eipTEventlog", obj, true);
  }

  public void removeFromEipTEventlog(
      com.aimluck.eip.cayenne.om.portlet.EipTEventlog obj) {
  ...
  public void addToEipTMsgboardCategory(
      com.aimluck.eip.cayenne.om.portlet.EipTMsgboardCategory obj) {
    addToManyTarget("eipTMsgboardCategory", obj, true);
  }

  public void removeFromEipTMsgboardCategory(
      com.aimluck.eip.cayenne.om.portlet.EipTMsgboardCategory obj) {
  ...
  public void addToEipTReport(
      com.aimluck.eip.cayenne.om.portlet.EipTReport obj) {
    addToManyTarget("eipTReport", obj, true);
  }

  public void removeFromEipTReport(
      com.aimluck.eip.cayenne.om.portlet.EipTReport obj) {
  ...
  public void addToEipTTimeline(
      com.aimluck.eip.cayenne.om.portlet.EipTTimeline obj) {
    addToManyTarget("eipTTimeline", obj, true);
  }

  public void removeFromEipTTimeline(
      com.aimluck.eip.cayenne.om.portlet.EipTTimeline obj) {
  ...
  public void addToEipTTimelineLike(
      com.aimluck.eip.cayenne.om.portlet.EipTTimelineLike obj) {
    addToManyTarget("eipTTimelineLike", obj, true);
  }

  public void removeFromEipTTimelineLike(
      com.aimluck.eip.cayenne.om.portlet.EipTTimelineLike obj) {
  ...
  public void addToEipTTimelineLike1(
      com.aimluck.eip.cayenne.om.portlet.EipTTimelineLike obj) {
    addToManyTarget("eipTTimelineLike1", obj, true);
  }

  public void removeFromEipTTimelineLike1(
      com.aimluck.eip.cayenne.om.portlet.EipTTimelineLike obj) {
  ...
  public void removeFromEipTTodo(
      com.aimluck.eip.cayenne.om.portlet.EipTTodo obj) {
  ...
  public void addToEipTTodoCategory(
      com.aimluck.eip.cayenne.om.portlet.EipTTodoCategory obj) {
    addToManyTarget("eipTTodoCategory", obj, true);
  }

  public void removeFromEipTTodoCategory(
      com.aimluck.eip.cayenne.om.portlet.EipTTodoCategory obj) {
  ...
  public void addToEipTWorkflowRequest(
      com.aimluck.eip.cayenne.om.portlet.EipTWorkflowRequest obj) {
    addToManyTarget("eipTWorkflowRequest", obj, true);
  }

  public void removeFromEipTWorkflowRequest(
      com.aimluck.eip.cayenne.om.portlet.EipTWorkflowRequest obj) {
  ...
  public void addToTurbineUserGroupRole(
      com.aimluck.eip.cayenne.om.security.TurbineUserGroupRole obj) {
    addToManyTarget("turbineUserGroupRole", obj, true);
  }

  public void removeFromTurbineUserGroupRole(
      com.aimluck.eip.cayenne.om.security.TurbineUserGroupRole obj) {
