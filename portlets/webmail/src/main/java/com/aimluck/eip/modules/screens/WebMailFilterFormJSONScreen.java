...
import com.aimluck.eip.webmail.WebMailFilterMultiDelete;

/**
 * フィルタをJSONデータとして出力するクラスです。 <br />
 * 
 */
public class WebMailFilterFormJSONScreen extends ALJSONScreen {
  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(WebMailFolderFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      if (ALEipConstants.MODE_INSERT.equals(mode)) {
        ...
        WebMailFilterMultiDelete delete = new WebMailFilterMultiDelete();
      ...
      logger.error("[WebMailFilterFormJSONScreen]", e);
    }
