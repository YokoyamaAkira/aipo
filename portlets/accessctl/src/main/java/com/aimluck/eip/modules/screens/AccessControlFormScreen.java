...
/**
 * AccessControlFormScreen
 * 
 */
public class AccessControlFormScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(AccessControlFormScreen.class.getName());
  ...
  protected void doAccessControl_form(RunData rundata, Context context) {
    AccessControlFormData formData = new AccessControlFormData();
    formData.initField();
