...
import com.aimluck.eip.cabinet.CabinetFileFormData;
import com.aimluck.eip.cabinet.CabinetFileMultiDelete;
...
/**
 * 共有フォルダのファイルをJSONデータとして出力するクラスです。 <br />
 * 
 */
public class CabinetFileFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(CabinetFileFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      if (ALEipConstants.MODE_INSERT.equals(mode)) {
        ...
        CabinetFileMultiDelete delete = new CabinetFileMultiDelete();
      ...
      logger.error("[CabinetFileFormJSONScreen]", e);
    }
