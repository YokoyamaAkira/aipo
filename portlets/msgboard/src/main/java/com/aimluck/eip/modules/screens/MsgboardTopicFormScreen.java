...
public class MsgboardTopicFormScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(MsgboardTopicFormScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    ...
    try {
      doMsgboard_form(rundata, context);
    } catch (Exception ex) {
      logger.error("[MsgboardTopicFormScreen] Exception.", ex);
      ALEipUtils.redirectDBError(rundata);
    }
  }

  protected void doMsgboard_form(RunData rundata, Context context) {
