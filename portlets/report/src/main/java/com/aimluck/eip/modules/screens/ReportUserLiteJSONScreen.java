...
/**
 * 報告書のあて先のユーザーのBeanです。 <br />
 *
 */
public class ReportUserLiteJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ReportUserLiteJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      if ("group".equals(mode)) {
        ...
        json =
          JSONArray.fromObject(ReportUtils.getAuthorityUsers(
            rundata,
            groupname,
            include_loginuser));
      } else {
      ...
      logger.error("[ReportUserLiteJSONScreen]", e);
    }
