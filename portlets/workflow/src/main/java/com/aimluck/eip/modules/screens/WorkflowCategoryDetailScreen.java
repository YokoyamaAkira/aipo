...
/**
 * ワークフロー分類の詳細画面を処理するクラスです。 <br />
 * 
 */
public class WorkflowCategoryDetailScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(WorkflowCategoryDetailScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    try {
      WorkflowCategorySelectData detailData = new WorkflowCategorySelectData();
