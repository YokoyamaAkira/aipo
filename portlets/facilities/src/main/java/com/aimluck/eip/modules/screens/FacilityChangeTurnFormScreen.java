 ...
 * 
 */
public class FacilityChangeTurnFormScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(FacilityChangeTurnFormScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    ...
    try {
      ...
      logger.error("[FacilityChangeTurnFormScreen] Exception.", ex);
