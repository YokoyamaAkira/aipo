...
import com.aimluck.eip.facilities.FacilityMultiDelete;

/**
 * 設備をJSONデータとして出力するクラスです。 <br />
 * 
 */
public class FacilityFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(FacilityFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      if (ALEipConstants.MODE_INSERT.equals(mode)) {
        ...
        FacilityMultiDelete delete = new FacilityMultiDelete();
      ...
      logger.error("[FacilityFormJSONScreen]", e);
    }
