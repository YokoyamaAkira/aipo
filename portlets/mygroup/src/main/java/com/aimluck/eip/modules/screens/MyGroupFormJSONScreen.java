...
/**
 * マイグループをJSONデータとして出力するクラスです。 <br />
 * 
 */
public class MyGroupFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(MyGroupFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      logger.error("[PageFormJSONScreen]", e);
    }
