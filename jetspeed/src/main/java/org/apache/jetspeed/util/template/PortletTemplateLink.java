...
/**
 * A customized version of the JetspeedTemplateLink that reacts to the Portlet
 * context and allows you to manipulate the lowest level pane if it exists.
 * 
 * @author <a href="mailto:raphael@apache.org">Rapha�l Luta</a>
 * @deprecated Since 2002-03-05. Use JetspeedTemplateLink with the
 *             setPortlet(Portlet) method to give it the right context.
...
public class PortletTemplateLink extends JetspeedTemplateLink {
  ...
  private final JetspeedRunData data = null;
  ...
  public String getPanelKey() {
    ...
    try {
      PortletController controller =
        portlet.getPortletConfig().getPortletSet().getController();
