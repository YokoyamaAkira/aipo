...
public class MetaData implements Serializable {
  ...
  public static final String DEFAULT_TITLE = JetspeedResources
    .getString(JetspeedResources.DEFAULT_TITLE_KEY);

  public static final String DEFAULT_DESCRIPTION = JetspeedResources
    .getString(JetspeedResources.DEFAULT_DESCRIPTION_KEY);

  public static final String DEFAULT_IMAGE = JetspeedResources
    .getString(JetspeedResources.DEFAULT_IMAGE_KEY);

  /**
   * Hashtable to store all the properties
   */
  private final Hashtable<Object, Object> data =
  ...
  /**
   * Returns the title for the given locale, if the title isn't defined in this
   * locale or the locale, return the default title
   */
  ...
  /**
   * Returns the descriptive image for the given locale, if the image isn't
   * defined in this locale or the locale, return the default image
   */
   ...
   * 
   * <p>
   * For example, title.fr_FR will store the French title, while title.sp will
   * keep the Spanich one. title will keep the value which can be used when
   * defaulting because en entry is not present for the queried locale
   * </p>
   */
