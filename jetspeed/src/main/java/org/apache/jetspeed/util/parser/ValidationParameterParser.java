 ...
 * methods that begin with validate[AttributeName]. Works with Torque-generated
 * beans. To use this class, override the TurbineResources.properties:
 * 
 * services.RunDataService.default.parameter.parser=org.apache.turbine.util.
 * parser.DefaultParameterParser
 * 
 * @author <a href="mailto:taylor@apache.org">David Sean Taylor</a>
 * @version $Id: ValidationParameterParser.java,v 1.6 2004/02/23 03:18:08 jford
 *          Exp $
 */
public class ValidationParameterParser extends DefaultJetspeedParameterParser
   ...
   * parameters, where a (case-insensitive) name match between the bean property
   * and the parameter is looked for.
   * 
   * @param bean
   *          An Object.
   * @exception Exception
  ...
  public void setProperties(Object bean) throws Exception {
    ...
    for (int i = 0; i < props.length; i++) {
      ...
      if (setter != null
        && (containsKey(propname) || containsDateSelectorKeys(propname) || containsTimeSelectorKeys(propname))) {
        /* VALIDATION */
   ...
   * parameters. Supports all types supported by getXXX methods plus a few more
   * that come for free because primitives have to be wrapped before being
   * passed to invoke anyway.
   * 
   * @param bean
   *          An Object.
   * @param prop
   ...
   *              , a generic exception.
   */
  protected void setMyProperty(Object bean, PropertyDescriptor prop)
      throws Exception {
   ...
   **/
  protected boolean validateProperty(Object bean, PropertyDescriptor prop)
      throws Exception {
    ...
    try {
      ...
      boolean isValidBool =
        ((Boolean) method.invoke(bean, methodParams)).booleanValue();
      return isValidBool;
