 ...
 * 
 * This bean can be used to interact with webservices via soap. The WSDL file
 * for the target web service is required since it contains the parameters
...
public class SoapAccessBean implements java.io.Serializable {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(SoapAccessBean.class.getName());
   ...
   * 
   * @param targetURI
   *          type: java.lang.String - desc: targetURI for the services
   * 
   * @param method
   *          type: java.lang.String - desc: service method
   */
   ...
   * 
   * The parameters property is used to set the various parameters required to
   * interact with the service.
   * 
   * @param parameters
   *          type: java.util.Vector - desc: stores service parameters
   */
   ...
   * 
   * @return java.util.Vector - desc: stores service parameters
   */
   ...
   * 
   * The parameters required by the service are defined within its WSDL
   * descriptor file
   * 
   * @param paramName
   *          type: java.lang.String - desc: the parameter name
   * 
   * @param paramClass
   *          type: java.lang.Class - desc: the class of the parameter
   * 
   * @param paramValue
   *          type:java.lang.Object - desc: the parameter
   * 
   * @param encoding
   *          type:java.lang.String - desc: the parameter encoding
   */
  public void addParameter(String paramName, Class<?> paramClass,
      Object paramValue, String encoding) {
    parameters.addElement(new Parameter(
      paramName,
      paramClass,
      paramValue,
      encoding));
   ...
   * 
   * @param url
   *          type: java.lang.String - desc: the service endpoint url defined in
   *          the WSDL file
   * 
   * @throws SOAPException
   *           type: org.apache.soap.SOAPException - desc: thrown if an
   *           exception occurs contains details of the exception
   * 
   * @return java.lang.Object - desc: the results of the service request must be
   *         cast by caller
   */
  public Object processRequest(String url) throws SOAPException {
    ...
    try {
      ...
      if (response.generatedFault() == true) {
        ...
        /*
         * get result as object caller must cast result to proper type
         */
