 ...
 * <code>logfile</code> - the content of the file indicated by
 * <code>selectedfile</code><br/>
 * 
 * 
...
public class LogfileViewerAction extends GenericMVCAction {
  ...
  private static final Logger logger = LogManager
    .getLogger(LogfileViewerAction.class.getName());
  ...
  protected void buildNormalContext(Portlet portlet, Context context,
    ...
    HashMap<Object, Object> fileNames = new HashMap<Object, Object>();
    ...
    while (loggerEnum.hasMoreElements()) {
      ...
      while (appenderEnum.hasMoreElements()) {
        ...
        if (appender instanceof FileAppender) {
          ...
          tempName =
            tempName.substring(tempName.lastIndexOf(System
