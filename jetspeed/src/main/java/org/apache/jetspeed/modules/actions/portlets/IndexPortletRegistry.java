 ...
 * @version $Id: IndexPortletRegistry.java,v 1.6 2004/03/31 04:49:10 morciuch
 *          Exp $
 */
public class IndexPortletRegistry extends SecureGenericMVCAction {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(IndexPortletRegistry.class.getName());
  ...
  public void doIndex(RunData rundata, Portlet portlet) {
    ...
    for (Iterator<?> i = Registry.get(Registry.PORTLET).listEntryNames(); i
      .hasNext();) {
      PortletEntry entry =
