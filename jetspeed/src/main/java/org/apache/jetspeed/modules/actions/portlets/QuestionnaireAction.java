...
public class QuestionnaireAction extends JspPortletAction {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(QuestionnaireAction.class.getName());

  /**
   * Build the normal state content for this portlet.
   * 
   * @param portlet
   *          The jsp-based portlet that is being built.
   * @param rundata
  ...
  protected void buildNormalContext(Portlet portlet, RunData rundata) {
    ...
    // After successful send, the user may or may not click the Continue button
    // so
  ...
  public void doEmail(RunData rundata, Portlet portlet) {
    ...
    String emailFrom =
      JetspeedResources.getString("mail.support", "david@bluesunrise.com");
    String emailTo =
    ...
    try {
      ...
      message.setSubject("Jetspeed Questionnaire from "
