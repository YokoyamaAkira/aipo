...
public class FileUploader {
  ...
  public boolean upload(FileItem fileItem, String location, String fileTypes[]) {
    ...
    try {
      ...
      /*
       * boolean isFileType = false; for (int i = 0; i < fileTypes.length; i++)
       * { if (contentType.equalsIgnoreCase(fileTypes[i])) { isFileType = true;
       * break; } }
       * 
       * if (isFileType == true || fileTypes == null || fileTypes.length == 0) {
       * fileItem.write(location + filename); hasUpload = true; }
       */
