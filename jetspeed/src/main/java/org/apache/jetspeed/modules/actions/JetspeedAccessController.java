...
public class JetspeedAccessController extends Action {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(JetspeedAccessController.class.getName());
  ...
  protected void getACL(RunData data) {
     ...
     * data.getSession().getValue(AccessControlList.SESSION_KEY); if ( acl ==
     * null ) { //acl = TurbineSecurity.getACL( data.getUser() ); acl = null;
