...
/**
 * Generic jsp-based presentation style. The following default objects are put
 * in the context:
 * <UL>
 ...
 * 
 * <P>
 * Supporting jsp templates should be placed in
 ...
 * JspParameterPresentationStyle should be created. Override buildContext to
 * place custom objects in the jsp context.
 * </P>
 * 
 * <P>
 ...
 * @version $Id: JspParameterPresentationStyle.java,v 1.4 2004/02/23 03:01:20
 *          jford Exp $
 */
...
public class JspParameterPresentationStyle extends ParameterPresentationStyle {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(JspParameterPresentationStyle.class.getName());
   ...
   * @param context
   */
  public void buildContext(RunData data, String name, String value,
      Map<String, String> parms) {
