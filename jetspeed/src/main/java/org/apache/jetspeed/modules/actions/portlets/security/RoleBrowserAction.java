...
/**
 * This action sets up the template context for browsing of security roles in
 * the Turbine database.
 * 
 * @author <a href="mailto:taylor@apache.org">David Sean Taylor</a>
 * @version $Id: RoleBrowserAction.java,v 1.9 2004/02/23 02:53:08 jford Exp $
 */
public class RoleBrowserAction extends VelocityPortletAction {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(RoleBrowserAction.class.getName());
