...
public class CustomizeSetAction extends VelocityPortletAction {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(CustomizeSetAction.class.getName());
      ...
      for (int i = 0; i < pnames.length; i++) {
        ...
        if ((entry != null) && (portlets != null)) {
          ...
          if (addIt) {
            ...
            // {
            // Log.debug("CustomizeSetAction: setting default portlet security to ["
            // + defaultRef.getParent() + "]");
            // }
            // p.setSecurityRef(defaultRef);
            // }
  ...
  public static List<PortletEntry> buildPortletList(RunData data,
    ...
    Collections.sort(list, new Comparator<Object>() {
      ...
      public int compare(Object o1, Object o2) {
        String t1 =
          (((PortletEntry) o1).getTitle() != null) ? ((PortletEntry) o1)
            .getTitle()
            .toLowerCase() : ((PortletEntry) o1).getName().toLowerCase();
        String t2 =
          (((PortletEntry) o2).getTitle() != null) ? ((PortletEntry) o2)
            .getTitle()
            .toLowerCase() : ((PortletEntry) o2).getName().toLowerCase();
  ...
  public static List<PortletInfoEntry> buildInfoList(RunData data,
    ...
    Collections.sort(list, new Comparator<Object>() {
      ...
      public int compare(Object o1, Object o2) {
        String t1 =
          (((RegistryEntry) o1).getTitle() != null) ? ((RegistryEntry) o1)
            .getTitle() : ((RegistryEntry) o1).getName();
        String t2 =
          (((RegistryEntry) o2).getTitle() != null) ? ((RegistryEntry) o2)
            .getTitle() : ((RegistryEntry) o2).getName();
