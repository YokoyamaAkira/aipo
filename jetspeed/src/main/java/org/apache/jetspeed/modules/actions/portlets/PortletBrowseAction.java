...
/**
 * This action extends the RegistryBrowseAction to provide filtering for
 * portlets and add extra information into the context
 * 
...
public class PortletBrowseAction extends RegistryBrowseAction {
   ...
   * 
   * @see org.apache.jetspeed.modules.actions.portlets.RegistryBrowseAction#filter(java.util.List,
   *      java.lang.String[], java.lang.String[])
   */
  // akr @Override
  protected List<?> filter(List<PortletEntry> entries, String[] fields,
      String[] values) {
