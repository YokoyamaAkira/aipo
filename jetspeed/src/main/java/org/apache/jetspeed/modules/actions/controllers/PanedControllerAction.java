...
/**
 * This action builds a context suitable for controllers portlets in panes, ie
 * with only a subsetof defined portlets defined at any time. Should be
 * associated with a controller implementing PanedPortletController to work
 * correctly
 * 
