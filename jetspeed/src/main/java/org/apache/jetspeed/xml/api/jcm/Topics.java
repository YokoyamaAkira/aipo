...
public class Topics implements java.io.Serializable {
  ...
  private final java.util.Vector<Entry> _entryList;
  ...
  /**
    **/
  public java.util.Enumeration<Entry> enumerateEntry() {
  ...
  public Entry[] getEntry() {
    ...
    for (int index = 0; index < size; index++) {
      mArray[index] = _entryList.elementAt(index);
    }
    return mArray;
  } // -- Entry[] getEntry()
   ...
   * @param reader
   **/
  public static org.apache.jetspeed.xml.api.jcm.Topics unmarshal(
      java.io.Reader reader) throws org.exolab.castor.xml.MarshalException,
      org.exolab.castor.xml.ValidationException {
    return (org.apache.jetspeed.xml.api.jcm.Topics) Unmarshaller.unmarshal(
      org.apache.jetspeed.xml.api.jcm.Topics.class,
      reader);
