...
public class Channel implements java.io.Serializable {
  ...
  private final java.util.Vector<Item> _itemList;
  ...
  /**
    **/
  public java.util.Enumeration<Item> enumerateItem() {
  ...
  public Item getItem(int index) throws java.lang.IndexOutOfBoundsException {
    ...
    return _itemList.elementAt(index);
  } // -- Item getItem(int)
  ...
  public Item[] getItem() {
    ...
    for (int index = 0; index < size; index++) {
      mArray[index] = _itemList.elementAt(index);
    }
    return mArray;
  } // -- Item[] getItem()
   ...
   * @param reader
   **/
  public static org.apache.jetspeed.xml.api.jcm.Channel unmarshal(
      java.io.Reader reader) throws org.exolab.castor.xml.MarshalException,
      org.exolab.castor.xml.ValidationException {
    return (org.apache.jetspeed.xml.api.jcm.Channel) Unmarshaller.unmarshal(
      org.apache.jetspeed.xml.api.jcm.Channel.class,
      reader);
