...
public class Quote implements java.io.Serializable {
   ...
   * @param reader
   **/
  public static org.apache.jetspeed.xml.api.jcm.Quote unmarshal(
      java.io.Reader reader) throws org.exolab.castor.xml.MarshalException,
      org.exolab.castor.xml.ValidationException {
    return (org.apache.jetspeed.xml.api.jcm.Quote) Unmarshaller.unmarshal(
      org.apache.jetspeed.xml.api.jcm.Quote.class,
      reader);
