...
// Local classes
import org.apache.jetspeed.om.security.turbine.map.TurbineRolePermissionMapBuilder;
...
public abstract class BaseTurbineRolePermissionPeer extends BasePeer {
   ...
   *           into a TorqueException.
   */
  public static List<TurbineRolePermission> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseTurbineRolePermissionPeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static TurbineRolePermission row2Object(Record row, int offset,
  ...
  public static void populateObject(Record row, int offset,
      TurbineRolePermission obj) throws TorqueException {
    try {
  ...
  public static List<TurbineRolePermission> populateObjects(List<?> records)
      throws TorqueException {
    List<TurbineRolePermission> results =
      new ArrayList<TurbineRolePermission>(records.size());
      ...
      results
        .add(
          TurbineRolePermissionPeer
            .row2Object(row, 1, TurbineRolePermissionPeer.getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseTurbineRolePermissionPeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseTurbineRolePermissionPeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<?> doSelect(TurbineRolePermission obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(TurbineRolePermission obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(TurbineRolePermission obj)
      throws TorqueException {
  ...
  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(TurbineRolePermission) method. It will take care
   ...
   * otherwise use the doUpdate(TurbineRolePermission) method. It will take care
   * of the connection details internally.
   *
   * @param obj
   *          the data object to update in the database.
   ...
   * use the doDelete(TurbineRolePermission) method. It will take care of the
   * connection details internally.
   *
   * @param obj
   *          the data object to delete in the database.
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseTurbineRolePermissionPeer.doDelete(pk, (Connection) null);
  }
    ...
    if (pks == null || pks.size() == 0) {
      ...
      while (iter.hasNext()) {
        ...
        Criteria.Criterion c0 =
          criteria.getNewCriterion(ROLE_ID, keys[0], Criteria.EQUAL);
        Criteria.Criterion c1 =
          criteria.getNewCriterion(PERMISSION_ID, keys[1], Criteria.EQUAL);
        c0.and(c1);
        criteria.or(c0);
      }
   ...
   *          int
   */
  public static TurbineRolePermission retrieveByPK(int role_id,
      int permission_id) throws TorqueException {
    Connection db = null;
    TurbineRolePermission retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
      retVal = retrieveByPK(role_id, permission_id, db);
    } finally {
      Torque.closeConnection(db);
    }
    return (retVal);
   ...
   */
  public static TurbineRolePermission retrieveByPK(int role_id,
      int permission_id, Connection con) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineRolePermission> doSelectJoinTurbineRole(
    ...
    c.addJoin(TurbineRolePermissionPeer.ROLE_ID, TurbineRolePeer.ROLE_ID);

    List<?> rows = BasePeer.doSelect(c);
    List<TurbineRolePermission> results =
      new ArrayList<TurbineRolePermission>();

    for (int i = 0; i < rows.size(); i++) {
      Record row = (Record) rows.get(i);

      Class<?> omClass = TurbineRolePermissionPeer.getOMClass();
      TurbineRolePermission obj1 =
        TurbineRolePermissionPeer.row2Object(row, 1, omClass);
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineRolePermission> doSelectJoinTurbinePermission(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to
    // another value so == check is okay and faster
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      TurbinePermission obj2 =
        TurbinePermissionPeer.row2Object(row, offset, omClass);
