...
/**
 * This class manages TurbineUserGroupRole objects. This class was autogenerated
 * by Torque on:
 *
 ...
 * references should be to TurbineUserGroupRoleManager
 */
public abstract class BaseTurbineUserGroupRoleManager extends
    AbstractBaseManager {
  ...
  public static TurbineUserGroupRoleManager getManager() {
    return (TurbineUserGroupRoleManager) Torque
      .getManager(
        TurbineUserGroupRoleManager.MANAGED_CLASS,
   ...
   *              if an error occurs
   */
  public static TurbineUserGroupRole getInstance() throws TorqueException {
   ...
   *              if an error occurs
   */
  public BaseTurbineUserGroupRoleManager() throws TorqueException {
    setClassName(
      "org.apache.jetspeed.om.security.turbine.TurbineUserGroupRole");
  }
   ...
   */
  protected TurbineUserGroupRole getInstanceImpl() throws TorqueException {
   ...
   *          <code>ObjectKey</code> value
   * @param fromCache
   *          if true, look for cached TurbineUserGroupRoles before loading from
   *          storage.
   */
  protected TurbineUserGroupRole getInstanceImpl(ObjectKey id,
      boolean fromCache) throws TorqueException {
   ...
   */
  protected boolean existsImpl(TurbineUserGroupRole om) throws TorqueException {
    Criteria crit = TurbineUserGroupRolePeer.buildCriteria(om);
