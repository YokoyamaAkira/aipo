...
// Local classes
import org.apache.jetspeed.om.security.turbine.map.TurbineGroupMapBuilder;
...
public abstract class BaseTurbineGroupPeer extends BasePeer {
  ...
  static {
    GROUP_ID = "TURBINE_GROUP.GROUP_ID";
    GROUP_NAME = "TURBINE_GROUP.GROUP_NAME";
    OBJECTDATA = "TURBINE_GROUP.OBJECTDATA";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
  ...
  protected static final String CLASSNAME_DEFAULT =
    "org.apache.jetspeed.om.security.turbine.TurbineGroup";
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseTurbineGroupPeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static TurbineGroup row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, TurbineGroup obj)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<TurbineGroup> doSelect(Criteria criteria)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<TurbineGroup> doSelect(Criteria criteria, Connection con)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseTurbineGroupPeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbineGroup> populateObjects(List<?> records)
      throws TorqueException {
    List<TurbineGroup> results = new ArrayList<TurbineGroup>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(TurbineGroupPeer.row2Object(row, 1, TurbineGroupPeer
        .getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseTurbineGroupPeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseTurbineGroupPeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbineGroup> doSelect(TurbineGroup obj)
      throws TorqueException {
  ...
  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(TurbineGroup) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   ...
   * otherwise use the doUpdate(TurbineGroup) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   * use the doDelete(TurbineGroup) method. It will take care of the connection
   * details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseTurbineGroupPeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(TurbineGroup obj) {
   ...
   *           Primary key was not found in database.
   */
  public static TurbineGroup retrieveByPK(int pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static TurbineGroup retrieveByPK(ObjectKey pk) throws TorqueException,
      NoRowsException, TooManyRowsException {
    Connection db = null;
  ...
  public static TurbineGroup retrieveByPK(ObjectKey pk, Connection con)
    ...
    List<TurbineGroup> v = doSelect(criteria, con);
    if (v.size() == 0) {
   ...
   *           into a TorqueException.
   */
  public static List<TurbineGroup> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<TurbineGroup> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
   ...
   *           into a TorqueException.
   */
  public static List<TurbineGroup> retrieveByPKs(List<?> pks, Connection dbcon)
      throws TorqueException {
    List<TurbineGroup> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<TurbineGroup>();
    } else {
      Criteria criteria = new Criteria();
