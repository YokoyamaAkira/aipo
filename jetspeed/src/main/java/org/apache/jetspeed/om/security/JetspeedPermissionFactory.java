...
/**
 * Factory class for creating Jetspeed Permissions. The permission class is
 * configured in the JR.p
 * 
 * @author <a href="mailto:taylor@apache.org">David Sean Taylor</a>
 * @version $Id: JetspeedPermissionFactory.java,v 1.4 2004/02/23 03:14:12 jford
 *          Exp $
 */
public class JetspeedPermissionFactory {
  ...
  public static Permission getInstance(boolean isNew)
    ...
    if (null == permissionClassName) {
      try {
        ...
        throw new PermissionException(
          "PermissionFactory: Failed to create a Class object for Permission implementation: "
            + e.toString());
      }
    }
    ...
    try {
      ...
      throw new PermissionException(
        "Failed instantiate an Permission implementation object: "
          + e.toString());
    }
