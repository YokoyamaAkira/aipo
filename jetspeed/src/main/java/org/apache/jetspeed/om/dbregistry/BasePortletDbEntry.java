 ...
 * references should be to PortletDbEntry
 */
public abstract class BasePortletDbEntry extends BaseObject {
  ...
  public void setId(long v) throws TorqueException {
    ...
    if (collPortletCategorys != null) {
      for (int i = 0; i < collPortletCategorys.size(); i++) {
        collPortletCategorys.get(i).setOwner(v);
      }
    }
    ...
    if (collPortletParameters != null) {
      for (int i = 0; i < collPortletParameters.size(); i++) {
        collPortletParameters.get(i).setPortletId(v);
      }
    }
    ...
    if (collPortletMediatypes != null) {
      for (int i = 0; i < collPortletMediatypes.size(); i++) {
        collPortletMediatypes.get(i).setId(v);
      }
    }
  }
  ...
  protected List<PortletCategory> collPortletCategorys =
    new ArrayList<PortletCategory>();;

  /**
   * Temporary storage of collPortletCategorys to save a possible db hit in the
  ...
  /**
   * Method called to associate a PortletCategory object to this object through
   * the PortletCategory foreign key attribute
   * 
   * @param PortletCategory
   *          l
   */
   ...
   * Otherwise returns the results of getPortletCategorys(new Criteria())
   */
   ...
   * it returns the collection. Otherwise if this PortletDbEntry has previously
   * been saved, it will retrieve related PortletCategorys from storage. If this
   * PortletDbEntry is new, it will return an empty collection or the current
   * collection, the criteria is ignored on a new object.
   */
  public List<PortletCategory> getPortletCategorys(Criteria criteria)
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getPortletCategorys(new
   * Criteria(),Connection) This method takes in the Connection also as input so
   * that referenced objects can also be obtained using a Connection that is
   * taken as input
   */
  public List<PortletCategory> getPortletCategorys(Connection con)
      throws TorqueException {
    if (collPortletCategorys == null) {
   ...
   * been saved, it will retrieve related PortletCategorys from storage. If this
   * PortletDbEntry is new, it will return an empty collection or the current
   * collection, the criteria is ignored on a new object. This method takes in
   * the Connection also as input so that referenced objects can also be
   * obtained using a Connection that is taken as input
   */
  public List<PortletCategory> getPortletCategorys(Criteria criteria,
  ...
  /**
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this PortletDbEntry is new, it will
   * return an empty collection; or if this PortletDbEntry has previously been
   * saved, it will retrieve related PortletCategorys from storage.
   * 
   ...
   * PortletDbEntry.
   */
  protected List<PortletCategory> getPortletCategorysJoinPortletDbEntry(
    ...
    if (collPortletCategorys == null) {
      if (isNew()) {
        ...
        criteria.add(PortletCategoryPeer.OWNER, getId());
        collPortletCategorys =
          PortletCategoryPeer.doSelectJoinPortletDbEntry(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
  ...
  /**
   * Temporary storage of collPortletParameters to save a possible db hit in the
   * event objects are add to the collection, but the complete collection is
   * never requested.
   */
  ...
  /**
   * Method called to associate a PortletParameter object to this object through
   * the PortletParameter foreign key attribute
   * 
   * @param PortletParameter
   *          l
   */
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getPortletParameters(new Criteria())
   */
   ...
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this PortletDbEntry has previously
   * been saved, it will retrieve related PortletParameters from storage. If
   * this PortletDbEntry is new, it will return an empty collection or the
   * current collection, the criteria is ignored on a new object.
   */
  public List<PortletParameter> getPortletParameters(Criteria criteria)
      throws TorqueException {
    if (collPortletParameters == null) {
      if (isNew()) {
        collPortletParameters = new ArrayList<PortletParameter>();
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getPortletParameters(new
   * Criteria(),Connection) This method takes in the Connection also as input so
   * that referenced objects can also be obtained using a Connection that is
   * taken as input
   */
  public List<PortletParameter> getPortletParameters(Connection con)
      throws TorqueException {
    if (collPortletParameters == null) {
   ...
   * it returns the collection. Otherwise if this PortletDbEntry is new, it will
   * return an empty collection; or if this PortletDbEntry has previously been
   * saved, it will retrieve related PortletParameters from storage.
   * 
   * This method is protected by default in order to keep the public api
   * reasonable. You can provide public methods for those you actually need in
   * PortletDbEntry.
   */
  protected List<PortletParameter> getPortletParametersJoinPortletDbEntry(
      Criteria criteria) throws TorqueException {
    if (collPortletParameters == null) {
      if (isNew()) {
        collPortletParameters = new ArrayList<PortletParameter>();
        ...
        collPortletParameters =
          PortletParameterPeer.doSelectJoinPortletDbEntry(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
  ...
  /**
   * Temporary storage of collPortletMediatypes to save a possible db hit in the
   * event objects are add to the collection, but the complete collection is
   * never requested.
   */
  ...
  /**
   * Method called to associate a PortletMediatype object to this object through
   * the PortletMediatype foreign key attribute
   * 
   * @param PortletMediatype
   *          l
   */
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getPortletMediatypes(new Criteria())
   */
   ...
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this PortletDbEntry has previously
   * been saved, it will retrieve related PortletMediatypes from storage. If
   * this PortletDbEntry is new, it will return an empty collection or the
   * current collection, the criteria is ignored on a new object.
   */
  public List<PortletMediatype> getPortletMediatypes(Criteria criteria)
      throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<PortletMediatype>();
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getPortletMediatypes(new
   * Criteria(),Connection) This method takes in the Connection also as input so
   * that referenced objects can also be obtained using a Connection that is
   * taken as input
   */
  public List<PortletMediatype> getPortletMediatypes(Connection con)
      throws TorqueException {
    if (collPortletMediatypes == null) {
   ...
   * it returns the collection. Otherwise if this PortletDbEntry is new, it will
   * return an empty collection; or if this PortletDbEntry has previously been
   * saved, it will retrieve related PortletMediatypes from storage.
   * 
   * This method is protected by default in order to keep the public api
   * reasonable. You can provide public methods for those you actually need in
   * PortletDbEntry.
   */
  protected List<PortletMediatype> getPortletMediatypesJoinPortletDbEntry(
      Criteria criteria) throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<PortletMediatype>();
        ...
        collPortletMediatypes =
          PortletMediatypePeer.doSelectJoinPortletDbEntry(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
   ...
   * PortletDbEntry.
   */
  protected List<PortletMediatype> getPortletMediatypesJoinMediatype(
      Criteria criteria) throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<PortletMediatype>();
        ...
        criteria.add(PortletMediatypePeer.ID, getId());
        collPortletMediatypes =
          PortletMediatypePeer.doSelectJoinMediatype(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
  ...
  /**
   * Retrieves a field from the object by name passed in as a String. The String
   * must be one of the static Strings defined in this Class' Peer.
   */
  @Override
  ...
  /**
   * flag to prevent endless save loop, if this object is referenced by another
   * object which falls in this transaction.
   */
  ...
  public void save(Connection con) throws TorqueException {
    if (!alreadyInSave) {
      ...
      if (collPortletCategorys != null) {
        for (int i = 0; i < collPortletCategorys.size(); i++) {
          collPortletCategorys.get(i).save(con);
        }
      }

      if (collPortletParameters != null) {
        for (int i = 0; i < collPortletParameters.size(); i++) {
          collPortletParameters.get(i).save(con);
        }
      }

      if (collPortletMediatypes != null) {
        for (int i = 0; i < collPortletMediatypes.size(); i++) {
          collPortletMediatypes.get(i).save(con);
        }
      }
      alreadyInSave = false;
    }
  ...
  /**
   * Specify whether to cache the object after saving to the db. This method
   * returns false
   */
   ...
   */
  @Override
  public void setPrimaryKey(ObjectKey id) throws TorqueException {
  ...
  /**
   * Makes a copy of this object. It creates a new object filling in the simple
   * attributes. It then fills all the association collections.
   */
  public PortletDbEntry copy() throws TorqueException {
    ...
    for (int i = 0; i < v.size(); i++) {
      PortletCategory obj = v.get(i);
      copyObj.addPortletCategory(obj.copy());
    }

    List<PortletParameter> vv = getPortletParameters();
    for (int i = 0; i < vv.size(); i++) {
      PortletParameter obj = vv.get(i);
      copyObj.addPortletParameter(obj.copy());
    }

    List<PortletMediatype> v1 = getPortletMediatypes();
    for (int i = 0; i < v1.size(); i++) {
      PortletMediatype obj = v1.get(i);
  ...
  /**
   * returns a peer instance associated with this om. Since Peer classes are not
   * to have any instance attributes, this method returns the same instance for
   * all member of this class. The method could therefore be static, but this
   * would prevent one from overriding the behavior.
   */
