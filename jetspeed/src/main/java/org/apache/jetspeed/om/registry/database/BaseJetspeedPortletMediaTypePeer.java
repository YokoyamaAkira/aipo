 ...
 * @version $Id: BaseJetspeedPortletMediaTypePeer.java,v 1.3 2004/04/06 23:00:16
 *          morciuch Exp $
 */
public class BaseJetspeedPortletMediaTypePeer extends BasePeer {
  ...
  protected static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BaseJetspeedPortletMediaTypePeer.class.getName());
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, BaseMediaType obj)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<BaseMediaType> doSelect(Criteria criteria)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseMediaType> populateObjects(List<?> records)
      throws TorqueException {
    List<BaseMediaType> results = new ArrayList<BaseMediaType>(records.size());
    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(BaseJetspeedPortletMediaTypePeer.row2Object(
        row,
        1,
   ...
   *           into a TorqueException.
   */
  public static List<BaseMediaType> doSelect(BasePortletEntry obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static BaseMediaType retrieveByPK(ObjectKey pk) throws TorqueException {
    Connection db = null;
   ...
   *           into a TorqueException.
   */
  public static List<BaseMediaType> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
   ...
   *           into a TorqueException.
   */
  public static List<BaseMediaType> retrieveById(ObjectKey pk)
      throws TorqueException {
    Connection db = null;
    List<BaseMediaType> retVal = null;
    try {
