...
/**
 * This class manages PortletParameter objects. This class was autogenerated by
 * Torque on:
 *
 ...
 * references should be to PortletParameterManager
 */
public abstract class BasePortletParameterManager extends AbstractBaseManager {
  ...
  protected static String DEFAULT_MANAGER_CLASS =
    "org.apache.jetspeed.om.dbregistry.PortletParameterManager";

  /**
   * Retrieves an implementation of the manager, based on the settings in the
   * configuration.
   *
   * @return an implementation of PortletParameterManager.
   */
  public static PortletParameterManager getManager() {
    return (PortletParameterManager) Torque
      .getManager(
        PortletParameterManager.MANAGED_CLASS,
   ...
   *
   * @return a <code>PortletParameter</code> value
   * @exception TorqueException
   *              if an error occurs
   */
  public static PortletParameter getInstance() throws TorqueException {
   ...
   *              if an error occurs
   */
  public static PortletParameter getInstance(ObjectKey id)
   ...
   *              if an error occurs
   */
  public static PortletParameter getInstance(ObjectKey id, boolean fromCache)
      throws TorqueException {
   ...
   *              if an error occurs
   */
  public static PortletParameter getInstance(long id) throws TorqueException {
   ...
   *              if an error occurs
   */
  public static PortletParameter getInstance(long id, boolean fromCache)
      throws TorqueException {
  ...
  public static boolean exists(PortletParameter obj) throws TorqueException {
  ...
  /**
   * Creates a new <code>BasePortletParameterManager</code> instance.
   *
   * @exception TorqueException
   *              if an error occurs
   */
  public BasePortletParameterManager() throws TorqueException {
    setClassName("org.apache.jetspeed.om.dbregistry.PortletParameter");
  }

  /**
   * Get a fresh instance of a PortletParameterManager
   */
  protected PortletParameter getInstanceImpl() throws TorqueException {
    PortletParameter obj = null;
    try {
      obj = (PortletParameter) getOMInstance();
    } catch (Exception e) {
   ...
   */
  protected PortletParameter getInstanceImpl(ObjectKey id)
      throws TorqueException {
    return (PortletParameter) getOMInstance(id);
  }
   ...
   *          <code>ObjectKey</code> value
   * @param fromCache
   *          if true, look for cached PortletParameters before loading from
   *          storage.
   */
  protected PortletParameter getInstanceImpl(ObjectKey id, boolean fromCache)
      throws TorqueException {
    return (PortletParameter) getOMInstance(id, fromCache);
  }

  /**
   * Gets a list of PortletParameters based on id's.
   *
   * @param ids
   ...
   */
  protected boolean existsImpl(PortletParameter om) throws TorqueException {
    Criteria crit = PortletParameterPeer.buildCriteria(om);
  ...
  @Override
  protected List<PortletParameter> retrieveStoredOMs(List ids)
      throws TorqueException {
