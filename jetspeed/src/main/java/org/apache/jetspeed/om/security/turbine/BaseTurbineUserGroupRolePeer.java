...
// Local classes
import org.apache.jetspeed.om.security.turbine.map.TurbineUserGroupRoleMapBuilder;
 ...
 *
 */
public abstract class BaseTurbineUserGroupRolePeer extends BasePeer {
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseTurbineUserGroupRolePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static TurbineUserGroupRole row2Object(Record row, int offset,
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset,
      TurbineUserGroupRole obj) throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<TurbineUserGroupRole> populateObjects(List<?> records)
      throws TorqueException {
    List<TurbineUserGroupRole> results =
      new ArrayList<TurbineUserGroupRole>(records.size());
      ...
      results
        .add(
          TurbineUserGroupRolePeer
            .row2Object(row, 1, TurbineUserGroupRolePeer.getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseTurbineUserGroupRolePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseTurbineUserGroupRolePeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<?> doSelect(TurbineUserGroupRole obj)
      throws TorqueException {
  ...
  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(TurbineUserGroupRole) method. It will take care
   * of the connection details internally.
   *
   * @param obj
   ...
   * otherwise use the doUpdate(TurbineUserGroupRole) method. It will take care
   * of the connection details internally.
   *
   * @param obj
   *          the data object to update in the database.
   ...
   * use the doDelete(TurbineUserGroupRole) method. It will take care of the
   * connection details internally.
   *
   * @param obj
   *          the data object to delete in the database.
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseTurbineUserGroupRolePeer.doDelete(pk, (Connection) null);
  }
  ...
  public static List<?> retrieveByPKs(List<?> pks, Connection dbcon)
    ...
    if (pks == null || pks.size() == 0) {
      ...
      while (iter.hasNext()) {
        ...
        SimpleKey[] keys = (SimpleKey[]) pk.getValue();
        Criteria.Criterion c0 =
          criteria.getNewCriterion(USER_ID, keys[0], Criteria.EQUAL);
        Criteria.Criterion c1 =
          criteria.getNewCriterion(GROUP_ID, keys[1], Criteria.EQUAL);
        c0.and(c1);
        Criteria.Criterion c2 =
          criteria.getNewCriterion(ROLE_ID, keys[2], Criteria.EQUAL);
        c1.and(c2);
        criteria.or(c0);
      }
   ...
   *          int
   */
  public static TurbineUserGroupRole retrieveByPK(int user_id, int group_id,
      int role_id) throws TorqueException {
    Connection db = null;
    TurbineUserGroupRole retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
      retVal = retrieveByPK(user_id, group_id, role_id, db);
    } finally {
      Torque.closeConnection(db);
    }
    return (retVal);
   ...
   */
  public static TurbineUserGroupRole retrieveByPK(int user_id, int group_id,
      int role_id, Connection con) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineUserGroupRole> doSelectJoinTurbineUser(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    ...
    c.addJoin(TurbineUserGroupRolePeer.USER_ID, TurbineUserPeer.USER_ID);
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      TurbineUserGroupRole obj1 =
        TurbineUserGroupRolePeer.row2Object(row, 1, omClass);
      omClass = TurbineUserPeer.getOMClass();
      TurbineUser obj2 = TurbineUserPeer.row2Object(row, offset, omClass);
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineUserGroupRole> doSelectJoinTurbineGroup(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to
    // another value so == check is okay and faster
    ...
    c.addJoin(TurbineUserGroupRolePeer.GROUP_ID, TurbineGroupPeer.GROUP_ID);
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      TurbineGroup obj2 = TurbineGroupPeer.row2Object(row, offset, omClass);
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineUserGroupRole> doSelectJoinTurbineRole(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to
    // another value so == check is okay and faster
    ...
    c.addJoin(TurbineUserGroupRolePeer.ROLE_ID, TurbineRolePeer.ROLE_ID);
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      TurbineRole obj2 = TurbineRolePeer.row2Object(row, offset, omClass);
  ...
  /**
   * selects a collection of TurbineUserGroupRole objects pre-filled with all
   * related objects.
   *
   * This method is protected by default in order to keep the public api
   * reasonable. You can provide public methods for those you actually need in
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineUserGroupRole> doSelectJoinAllExceptTurbineUser(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      omClass = TurbineGroupPeer.getOMClass();
      TurbineGroup obj2 = TurbineGroupPeer.row2Object(row, offset2, omClass);
      ...
      omClass = TurbineRolePeer.getOMClass();
      TurbineRole obj3 = TurbineRolePeer.row2Object(row, offset3, omClass);
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineUserGroupRole> doSelectJoinAllExceptTurbineGroup(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to another value
    // so == check is okay and faster
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      omClass = TurbineUserPeer.getOMClass();
      TurbineUser obj2 = TurbineUserPeer.row2Object(row, offset2, omClass);
   ...
   *           into a TorqueException.
   */
  protected static List<TurbineUserGroupRole> doSelectJoinAllExceptTurbineRole(
      Criteria c) throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to another value
    // so == check is okay and faster
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      omClass = TurbineGroupPeer.getOMClass();
      TurbineGroup obj3 = TurbineGroupPeer.row2Object(row, offset3, omClass);
