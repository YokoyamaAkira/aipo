 ...
 * @version $Id: BaseJetspeedPortletCategoryPeer.java,v 1.3 2004/04/06 23:00:16
 *          morciuch Exp $
 */
public class BaseJetspeedPortletCategoryPeer extends BasePeer {
  ...
  protected static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BaseJetspeedPortletCategoryPeer.class.getName());
   ...
   */
  public static List<BaseCategory> resultSet2Objects(java.sql.ResultSet results)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> doSelect(Criteria criteria)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> doSelect(Criteria criteria, Connection con)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> populateObjects(List<?> records)
      throws TorqueException {
    List<BaseCategory> results = new ArrayList<BaseCategory>(records.size());
    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(BaseJetspeedPortletCategoryPeer.row2Object(
        row,
        1,
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> doSelect(BasePortletEntry obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static BaseCategory retrieveByPK(ObjectKey pk) throws TorqueException {
    Connection db = null;
  ...
  public static BaseCategory retrieveByPK(ObjectKey pk, Connection con)
    ...
    List<BaseCategory> v = doSelect(criteria, con);
    if (v.size() != 1) {
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<BaseCategory> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> retrieveByPKs(List<?> pks, Connection dbcon)
      throws TorqueException {
    List<BaseCategory> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<BaseCategory>();
    } else {
      Criteria criteria = new Criteria();
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> retrieveById(int pk) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> retrieveById(ObjectKey pk)
      throws TorqueException {
    Connection db = null;
    List<BaseCategory> retVal = null;
    try {
   ...
   *           into a TorqueException.
   */
  public static List<BaseCategory> retrieveById(ObjectKey pk, Connection con)
      throws TorqueException {
    Criteria criteria = buildCriteria(pk);
