...
// Local classes
import org.apache.jetspeed.om.dbregistry.map.MediatypeMapBuilder;
 ...
 * 
 */
public abstract class BaseMediatypePeer extends BasePeer {
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(MediatypeMapBuilder.CLASS_NAME);
  }
  ...
  static {
    ...
    if (Torque.isInit()) {
      ...
      Torque.registerMapBuilder(MediatypeMapBuilder.CLASS_NAME);
    }
  }
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseMediatypePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static Mediatype row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, Mediatype obj)
      throws TorqueException {
    try {
      ...
      obj.setMimetype(row.getValue(offset + 3).asString());
      obj.setRole(row.getValue(offset + 4).asString());
      obj.setTitle(row.getValue(offset + 5).asString());
      obj.setDescription(row.getValue(offset + 6).asString());
      obj.setImage(row.getValue(offset + 7).asString());
    } catch (DataSetException e) {
      throw new TorqueException(e);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<Mediatype> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<Mediatype> populateObjects(List<?> records)
    ...
    for (int i = 0; i < records.size(); i++) {
      ...
      results.add(MediatypePeer.row2Object(row, 1, MediatypePeer.getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseMediatypePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseMediatypePeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static void doInsert(Mediatype obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(Mediatype obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(Mediatype obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(Mediatype) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   ...
   *           into a TorqueException.
   */
  public static void doInsert(Mediatype obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(Mediatype) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(Mediatype obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(Mediatype) method. It will take care of the connection
   * details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(Mediatype obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseMediatypePeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(Mediatype obj) {
   ...
   *           Primary key was not found in database.
   */
  public static Mediatype retrieveByPK(long pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static Mediatype retrieveByPK(ObjectKey pk) throws TorqueException,
      NoRowsException, TooManyRowsException {
    Connection db = null;
   ...
   *           Primary key was not found in database.
   */
  public static Mediatype retrieveByPK(ObjectKey pk, Connection con)
