...
// Local classes
import org.apache.jetspeed.om.dbregistry.map.PortletCategoryMapBuilder;
 ...
 * 
 */
public abstract class BasePortletCategoryPeer extends BasePeer {
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(PortletCategoryMapBuilder.CLASS_NAME);
  }
  ...
  static {
    ...
    if (Torque.isInit()) {
      ...
      Torque.registerMapBuilder(PortletCategoryMapBuilder.CLASS_NAME);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletCategory> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BasePortletCategoryPeer.doInsert(criteria, (Connection) null);
  }
  ...
  public static void addSelectColumns(Criteria criteria) throws TorqueException {
    ...
    criteria.addSelectColumn(GROUPE);
   ...
   *           into a TorqueException.
   */
  public static PortletCategory row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, PortletCategory obj)
      throws TorqueException {
    try {
      obj.setId(row.getValue(offset + 0).asLong());
      obj.setName(row.getValue(offset + 1).asString());
      obj.setGroup(row.getValue(offset + 2).asString());
      obj.setOwner(row.getValue(offset + 3).asLong());
    } catch (DataSetException e) {
      throw new TorqueException(e);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletCategory> doSelect(Criteria criteria)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<PortletCategory> doSelect(Criteria criteria, Connection con)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BasePortletCategoryPeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletCategory> populateObjects(List<?> records)
      throws TorqueException {
    List<PortletCategory> results =
      new ArrayList<PortletCategory>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(PortletCategoryPeer.row2Object(row, 1, PortletCategoryPeer
        .getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BasePortletCategoryPeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BasePortletCategoryPeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletCategory> doSelect(PortletCategory obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doInsert(PortletCategory obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(PortletCategory obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(PortletCategory obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(PortletCategory) method. It will take care of
   ...
   *           into a TorqueException.
   */
  public static void doInsert(PortletCategory obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(PortletCategory) method. It will take care of
   * the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(PortletCategory obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(PortletCategory) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(PortletCategory obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BasePortletCategoryPeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(PortletCategory obj) {
    Criteria criteria = new Criteria(DATABASE_NAME);
    if (!obj.isNew()) {
      criteria.add(ID, obj.getId());
    }
    criteria.add(NAME, obj.getName());
    criteria.add(GROUPE, obj.getGroup());
    criteria.add(OWNER, obj.getOwner());
    return criteria;
  }
   ...
   *           Primary key was not found in database.
   */
  public static PortletCategory retrieveByPK(long pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static PortletCategory retrieveByPK(ObjectKey pk)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Connection db = null;
    PortletCategory retVal = null;
    try {
   ...
   *           Primary key was not found in database.
   */
  public static PortletCategory retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Criteria criteria = buildCriteria(pk);
    List<PortletCategory> v = doSelect(criteria, con);
    if (v.size() == 0) {
   ...
   *           into a TorqueException.
   */
  public static List<PortletCategory> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<PortletCategory> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
  ...
  public static List<PortletCategory> retrieveByPKs(List<?> pks,
    ...
    List<PortletCategory> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<PortletCategory>();
    } else {
      Criteria criteria = new Criteria();
  ...
  /**
   * selects a collection of PortletCategory objects pre-filled with their
   ...
   *           into a TorqueException.
   */
  protected static List<PortletCategory> doSelectJoinPortletDbEntry(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    ...
    c.addJoin(PortletCategoryPeer.OWNER, PortletDbEntryPeer.ID);

    List<?> rows = BasePeer.doSelect(c);
    List<PortletCategory> results = new ArrayList<PortletCategory>();

    for (int i = 0; i < rows.size(); i++) {
      Record row = (Record) rows.get(i);

      Class<?> omClass = PortletCategoryPeer.getOMClass();
      PortletCategory obj1 = PortletCategoryPeer.row2Object(row, 1, omClass);
      omClass = PortletDbEntryPeer.getOMClass();
      PortletDbEntry obj2 = PortletDbEntryPeer.row2Object(row, offset, omClass);

      boolean newObject = true;
      for (int j = 0; j < results.size(); j++) {
        PortletCategory temp_obj1 = results.get(j);
        PortletDbEntry temp_obj2 = temp_obj1.getPortletDbEntry();
        if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey())) {
          newObject = false;
          temp_obj2.addPortletCategory(obj1);
          break;
        }
      }
      if (newObject) {
        obj2.initPortletCategorys();
        obj2.addPortletCategory(obj1);
      }
      results.add(obj1);
    }
    return results;
