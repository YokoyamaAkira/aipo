...
public abstract class BasePortletParameterPeer extends BasePeer {
  ...
  /** the column name for the CACHEDONVALUE field */
  public static final String CACHEDONVALUE;

  /** the column name for the CACHEDONNAME field */
  ...
  /** the column name for the PORTLET_ID field */
  ...
  static {
    ...
    SECURITY = "PORTLET_PARAMETER.SECURITY";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
   ...
   *           into a TorqueException.
   */
  public static List<PortletParameter> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BasePortletParameterPeer.doInsert(criteria, (Connection) null);
  }
  ...
  public static ObjectKey doInsert(Criteria criteria, Connection con)
    ...
    // check for conversion from boolean to int
    if (criteria.containsKey(CACHEDONVALUE)) {
      Object possibleBoolean = criteria.get(CACHEDONVALUE);
      if (possibleBoolean instanceof Boolean) {
        if (((Boolean) possibleBoolean).booleanValue()) {
          criteria.add(CACHEDONVALUE, 1);
        } else {
          criteria.add(CACHEDONVALUE, 0);
        }
      }
    }
    // check for conversion from boolean to int
    if (criteria.containsKey(CACHEDONNAME)) {
      Object possibleBoolean = criteria.get(CACHEDONNAME);
      if (possibleBoolean instanceof Boolean) {
        if (((Boolean) possibleBoolean).booleanValue()) {
          criteria.add(CACHEDONNAME, 1);
        } else {
          criteria.add(CACHEDONNAME, 0);
        }
      }
    }
   ...
   *           into a TorqueException.
   */
  public static PortletParameter row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, PortletParameter obj)
      throws TorqueException {
    try {
      ...
      obj.setHidden(row.getValue(offset + 4).asBoolean());
      obj.setRole(row.getValue(offset + 5).asString());
      obj.setCachedonvalue(row.getValue(offset + 6).asBoolean());
      obj.setCachedonname(row.getValue(offset + 7).asBoolean());
      obj.setTitle(row.getValue(offset + 8).asString());
      obj.setDescription(row.getValue(offset + 9).asString());
      obj.setImage(row.getValue(offset + 10).asString());
      obj.setPortletId(row.getValue(offset + 11).asLong());
      obj.setSecurityRef(row.getValue(offset + 12).asString());
    } catch (DataSetException e) {
      throw new TorqueException(e);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletParameter> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BasePortletParameterPeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
  ...
  public static List<PortletParameter> populateObjects(List<?> records)
      throws TorqueException {
    List<PortletParameter> results =
      new ArrayList<PortletParameter>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(PortletParameterPeer.row2Object(row, 1, PortletParameterPeer
        .getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BasePortletParameterPeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BasePortletParameterPeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletParameter> doSelect(PortletParameter obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doInsert(PortletParameter obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(PortletParameter obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(PortletParameter obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(PortletParameter) method. It will take care of
   ...
   *           into a TorqueException.
   */
  public static void doInsert(PortletParameter obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(PortletParameter) method. It will take care of
   * the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(PortletParameter obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(PortletParameter) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(PortletParameter obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BasePortletParameterPeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(PortletParameter obj) {
    ...
    criteria.add(CACHEDONVALUE, obj.getCachedonvalue());
    criteria.add(CACHEDONNAME, obj.getCachedonname());
    criteria.add(TITLE, obj.getTitle());
    criteria.add(DESCRIPTION, obj.getDescription());
    criteria.add(IMAGE, obj.getImage());
    criteria.add(PORTLET_ID, obj.getPortletId());
   ...
   *           Primary key was not found in database.
   */
  public static PortletParameter retrieveByPK(long pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static PortletParameter retrieveByPK(ObjectKey pk)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Connection db = null;
    PortletParameter retVal = null;
    try {
   ...
   *           Primary key was not found in database.
   */
  public static PortletParameter retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
   ...
   */
  public static List<PortletParameter> retrieveByPKs(List<?> pks,
      Connection dbcon) throws TorqueException {
  ...
  /**
   * selects a collection of PortletParameter objects pre-filled with their
   * PortletDbEntry objects.
   * 
  ...
  protected static List<PortletParameter> doSelectJoinPortletDbEntry(Criteria c)
    ...
    c.addJoin(PortletParameterPeer.PORTLET_ID, PortletDbEntryPeer.ID);

    // check for conversion from boolean to int
    if (c.containsKey(HIDDEN)) {
      Object possibleBoolean = c.get(HIDDEN);
      if (possibleBoolean instanceof Boolean) {
        if (((Boolean) possibleBoolean).booleanValue()) {
          c.add(HIDDEN, 1);
        } else {
    ...
    // check for conversion from boolean to int
    if (c.containsKey(CACHEDONVALUE)) {
      Object possibleBoolean = c.get(CACHEDONVALUE);
      if (possibleBoolean instanceof Boolean) {
        if (((Boolean) possibleBoolean).booleanValue()) {
          c.add(CACHEDONVALUE, 1);
        } else {
          c.add(CACHEDONVALUE, 0);
        }
      }
    }
    // check for conversion from boolean to int
    if (c.containsKey(CACHEDONNAME)) {
      Object possibleBoolean = c.get(CACHEDONNAME);
      if (possibleBoolean instanceof Boolean) {
        if (((Boolean) possibleBoolean).booleanValue()) {
          c.add(CACHEDONNAME, 1);
        } else {
          c.add(CACHEDONNAME, 0);
        }
      }
    }
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      PortletParameter obj1 = PortletParameterPeer.row2Object(row, 1, omClass);
      omClass = PortletDbEntryPeer.getOMClass();
      PortletDbEntry obj2 = PortletDbEntryPeer.row2Object(row, offset, omClass);

      boolean newObject = true;
      for (int j = 0; j < results.size(); j++) {
        PortletParameter temp_obj1 = results.get(j);
        PortletDbEntry temp_obj2 = temp_obj1.getPortletDbEntry();
        if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey())) {
          newObject = false;
          temp_obj2.addPortletParameter(obj1);
          break;
        }
      }
      if (newObject) {
        obj2.initPortletParameters();
        obj2.addPortletParameter(obj1);
      }
      results.add(obj1);
    }
    return results;
