 ...
 * references should be to TurbinePermission
 */
public abstract class BaseTurbinePermission extends BaseObject {
  ...
  public void setPermissionId(int v) throws TorqueException {
    ...
    if (collTurbineRolePermissions != null) {
      for (int i = 0; i < collTurbineRolePermissions.size(); i++) {
        collTurbineRolePermissions.get(i).setPermissionId(v);
      }
    }
  }
   ...
   * it returns the collection. Otherwise if this TurbinePermission has
   * previously been saved, it will retrieve related TurbineRolePermissions from
   * storage. If this TurbinePermission is new, it will return an empty
  ...
  public List<TurbineRolePermission> getTurbineRolePermissions(Criteria criteria)
    ...
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        ...
        criteria
          .add(TurbineRolePermissionPeer.PERMISSION_ID, getPermissionId());
        collTurbineRolePermissions =
   ...
   * storage. If this TurbinePermission is new, it will return an empty
   * collection or the current collection, the criteria is ignored on a new
   * object. This method takes in the Connection also as input so that
   * referenced objects can also be obtained using a Connection that is taken as
   * input
   */
  public List<TurbineRolePermission> getTurbineRolePermissions(
  ...
  /**
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this TurbinePermission is new, it
   * will return an empty collection; or if this TurbinePermission has
   * previously been saved, it will retrieve related TurbineRolePermissions from
   * storage.
   * 
  ...
  public void save() throws Exception {
    save(TurbinePermissionPeer.getMapBuilder().getDatabaseMap().getName());
  }
   ...
   */
  @Override
  public void setPrimaryKey(ObjectKey permissionId) throws TorqueException {
  ...
  public TurbinePermission copy() throws TorqueException {
    ...
    List<TurbineRolePermission> v = getTurbineRolePermissions();
    for (int i = 0; i < v.size(); i++) {
      TurbineRolePermission obj = v.get(i);
