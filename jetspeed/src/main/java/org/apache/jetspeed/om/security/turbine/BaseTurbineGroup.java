 ...
 * references should be to TurbineGroup
 */
public abstract class BaseTurbineGroup extends BaseObject {
  ...
  public void setGroupId(int v) throws TorqueException {
    ...
    if (collTurbineUserGroupRoles != null) {
      for (int i = 0; i < collTurbineUserGroupRoles.size(); i++) {
        collTurbineUserGroupRoles.get(i).setGroupId(v);
      }
    }
  }
   ...
   * it returns the collection. Otherwise if this TurbineGroup has previously
   * been saved, it will retrieve related TurbineUserGroupRoles from storage. If
   * this TurbineGroup is new, it will return an empty collection or the current
  ...
  /**
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this TurbineGroup is new, it will
   * return an empty collection; or if this TurbineGroup has previously been
   ...
   */
  @Override
  public void setPrimaryKey(ObjectKey groupId) throws TorqueException {
