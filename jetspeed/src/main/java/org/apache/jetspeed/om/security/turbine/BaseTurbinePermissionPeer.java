...
// Local classes
import org.apache.jetspeed.om.security.turbine.map.TurbinePermissionMapBuilder;
...
public abstract class BaseTurbinePermissionPeer extends BasePeer {
  ...
  public static final String TABLE_NAME = "TURBINE_PERMISSION";
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(TurbinePermissionMapBuilder.CLASS_NAME);
  }
  ...
  static {
    PERMISSION_ID = "TURBINE_PERMISSION.PERMISSION_ID";
    PERMISSION_NAME = "TURBINE_PERMISSION.PERMISSION_NAME";
    OBJECTDATA = "TURBINE_PERMISSION.OBJECTDATA";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
   ...
   *           into a TorqueException.
   */
  public static List<TurbinePermission> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseTurbinePermissionPeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static TurbinePermission row2Object(Record row, int offset,
      Class<?> cls) throws TorqueException {
    try {
      TurbinePermission obj = (TurbinePermission) cls.newInstance();
      TurbinePermissionPeer.populateObject(row, offset, obj);
  ...
  public static void populateObject(Record row, int offset,
      TurbinePermission obj) throws TorqueException {
    try {
      obj.setPermissionId(row.getValue(offset + 0).asInt());
      obj.setPermissionName(row.getValue(offset + 1).asString());
      obj.setObjectdata(row.getValue(offset + 2).asBytes());
    } catch (DataSetException e) {
      throw new TorqueException(e);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbinePermission> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseTurbinePermissionPeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbinePermission> populateObjects(List<?> records)
      throws TorqueException {
    List<TurbinePermission> results =
      new ArrayList<TurbinePermission>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(TurbinePermissionPeer.row2Object(
        row,
        1,
        TurbinePermissionPeer.getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseTurbinePermissionPeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseTurbinePermissionPeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbinePermission> doSelect(TurbinePermission obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doInsert(TurbinePermission obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(TurbinePermission obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(TurbinePermission obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(TurbinePermission) method. It will take care of
   ...
   *           into a TorqueException.
   */
  public static void doInsert(TurbinePermission obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(TurbinePermission) method. It will take care of
   * the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(TurbinePermission obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(TurbinePermission) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(TurbinePermission obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseTurbinePermissionPeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(ObjectKey pk) {
    ...
    criteria.add(PERMISSION_ID, pk);
    return criteria;
  }

  /** Build a Criteria object from the data object for this peer */
  public static Criteria buildCriteria(TurbinePermission obj) {
    Criteria criteria = new Criteria(DATABASE_NAME);
    if (!obj.isNew()) {
      criteria.add(PERMISSION_ID, obj.getPermissionId());
    }
    criteria.add(PERMISSION_NAME, obj.getPermissionName());
    criteria.add(OBJECTDATA, obj.getObjectdata());
    return criteria;
  }
   ...
   *           Primary key was not found in database.
   */
  public static TurbinePermission retrieveByPK(int pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static TurbinePermission retrieveByPK(ObjectKey pk)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Connection db = null;
    TurbinePermission retVal = null;
    try {
   ...
   *           Primary key was not found in database.
   */
  public static TurbinePermission retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
   ...
   *           into a TorqueException.
   */
  public static List<TurbinePermission> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<TurbinePermission> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
  ...
  public static List<TurbinePermission> retrieveByPKs(List<?> pks,
    ...
    List<TurbinePermission> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<TurbinePermission>();
    } else {
      Criteria criteria = new Criteria();
      criteria.addIn(PERMISSION_ID, pks);
