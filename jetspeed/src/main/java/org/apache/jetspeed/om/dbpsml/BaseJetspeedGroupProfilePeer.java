...
// Local classes
import org.apache.jetspeed.om.dbpsml.map.JetspeedGroupProfileMapBuilder;
 ...
 * 
 */
public abstract class BaseJetspeedGroupProfilePeer extends BasePeer {

  /** the default database name for this class */
  public static final String DATABASE_NAME = "default";

  /** the table name for this class */
  public static final String TABLE_NAME = "JETSPEED_GROUP_PROFILE";
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(JetspeedGroupProfileMapBuilder.CLASS_NAME);
  }
  ...
  static {
    PSML_ID = "JETSPEED_GROUP_PROFILE.PSML_ID";
    GROUP_NAME = "JETSPEED_GROUP_PROFILE.GROUP_NAME";
    MEDIA_TYPE = "JETSPEED_GROUP_PROFILE.MEDIA_TYPE";
    LANGUAGE = "JETSPEED_GROUP_PROFILE.LANGUAGE";
    COUNTRY = "JETSPEED_GROUP_PROFILE.COUNTRY";
    PAGE = "JETSPEED_GROUP_PROFILE.PAGE";
    PROFILE = "JETSPEED_GROUP_PROFILE.PROFILE";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
      ...
      Torque.registerMapBuilder(JetspeedGroupProfileMapBuilder.CLASS_NAME);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedGroupProfile> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseJetspeedGroupProfilePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static JetspeedGroupProfile row2Object(Record row, int offset,
      Class<?> cls) throws TorqueException {
    try {
      JetspeedGroupProfile obj = (JetspeedGroupProfile) cls.newInstance();
      JetspeedGroupProfilePeer.populateObject(row, offset, obj);
  ...
  public static void populateObject(Record row, int offset,
      JetspeedGroupProfile obj) throws TorqueException {
    try {
      obj.setPsmlId(row.getValue(offset + 0).asInt());
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedGroupProfile> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseJetspeedGroupProfilePeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedGroupProfile> populateObjects(List<?> records)
      throws TorqueException {
    List<JetspeedGroupProfile> results =
      new ArrayList<JetspeedGroupProfile>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(JetspeedGroupProfilePeer.row2Object(
        row,
        1,
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseJetspeedGroupProfilePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseJetspeedGroupProfilePeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedGroupProfile> doSelect(JetspeedGroupProfile obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doInsert(JetspeedGroupProfile obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(JetspeedGroupProfile obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(JetspeedGroupProfile obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(JetspeedGroupProfile) method. It will take care
   ...
   *           into a TorqueException.
   */
  public static void doInsert(JetspeedGroupProfile obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(JetspeedGroupProfile) method. It will take care
   * of the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(JetspeedGroupProfile obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(JetspeedGroupProfile) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(JetspeedGroupProfile obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseJetspeedGroupProfilePeer.doDelete(pk, (Connection) null);
  }
   ...
   *           Primary key was not found in database.
   */
  public static JetspeedGroupProfile retrieveByPK(int pk)
   ...
   *           Primary key was not found in database.
   */
  public static JetspeedGroupProfile retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Criteria criteria = buildCriteria(pk);
    List<JetspeedGroupProfile> v = doSelect(criteria, con);
    if (v.size() == 0) {
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedGroupProfile> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<JetspeedGroupProfile> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
  ...
  public static List<JetspeedGroupProfile> retrieveByPKs(List<?> pks,
    ...
    List<JetspeedGroupProfile> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<JetspeedGroupProfile>();
    } else {
      Criteria criteria = new Criteria();
      criteria.addIn(PSML_ID, pks);
