 ...
 * references should be to Mediatype
 */
public abstract class BaseMediatype extends BaseObject {
  /** The Peer class */
  private static final MediatypePeer peer = new MediatypePeer();
  ...
  public void setId(long v) throws TorqueException {
    ...
    if (collPortletMediatypes != null) {
      for (int i = 0; i < collPortletMediatypes.size(); i++) {
        collPortletMediatypes.get(i).setMediaId(v);
      }
    }
  }
   ...
   * it returns the collection. Otherwise if this Mediatype has previously been
   * saved, it will retrieve related PortletMediatypes from storage. If this
   * Mediatype is new, it will return an empty collection or the current
  ...
  /**
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this Mediatype is new, it will
   * return an empty collection; or if this Mediatype has previously been saved,
   * it will retrieve related PortletMediatypes from storage.
   * 
