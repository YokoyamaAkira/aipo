...
/**
 * This class manages EmailInbox objects. This class was autogenerated by Torque
 * on:
 *
 ...
 * references should be to EmailInboxManager
 */
public abstract class BaseEmailInboxManager extends AbstractBaseManager {
  ...
  protected static String DEFAULT_MANAGER_CLASS =
    "org.apache.jetspeed.om.apps.email.EmailInboxManager";

  /**
   * Retrieves an implementation of the manager, based on the settings in the
   * configuration.
   *
   * @return an implementation of EmailInboxManager.
   */
  public static EmailInboxManager getManager() {
    return (EmailInboxManager) Torque
      .getManager(
        EmailInboxManager.MANAGED_CLASS,
   ...
   *
   * @return a <code>EmailInbox</code> value
   * @exception TorqueException
   *              if an error occurs
   */
  public static EmailInbox getInstance() throws TorqueException {
   ...
   *              if an error occurs
   */
  public static EmailInbox getInstance(ObjectKey id) throws TorqueException {
   ...
   *              if an error occurs
   */
  public static EmailInbox getInstance(ObjectKey id, boolean fromCache)
   ...
   *              if an error occurs
   */
  public static EmailInbox getInstance(int id) throws TorqueException {
   ...
   *              if an error occurs
   */
  public static EmailInbox getInstance(int id, boolean fromCache)
      throws TorqueException {
  ...
  public static boolean exists(EmailInbox obj) throws TorqueException {
  ...
  /**
   * Creates a new <code>BaseEmailInboxManager</code> instance.
   *
   * @exception TorqueException
   *              if an error occurs
   */
  public BaseEmailInboxManager() throws TorqueException {
    setClassName("org.apache.jetspeed.om.apps.email.EmailInbox");
  }

  /**
   * Get a fresh instance of a EmailInboxManager
   */
  protected EmailInbox getInstanceImpl() throws TorqueException {
    EmailInbox obj = null;
    try {
      obj = (EmailInbox) getOMInstance();
    } catch (Exception e) {
  ...
  /**
   * Get a EmailInbox with the given id.
   *
   * @param id
   *          <code>ObjectKey</code> value
   */
  protected EmailInbox getInstanceImpl(ObjectKey id) throws TorqueException {
    return (EmailInbox) getOMInstance(id);
  }
   ...
   *          <code>ObjectKey</code> value
   * @param fromCache
   *          if true, look for cached EmailInboxs before loading from storage.
   */
  protected EmailInbox getInstanceImpl(ObjectKey id, boolean fromCache)
      throws TorqueException {
    return (EmailInbox) getOMInstance(id, fromCache);
  }

  /**
   * Gets a list of EmailInboxs based on id's.
   *
   * @param ids
   *          a List of <code>ObjectKeys</code> value
   * @return a <code>List</code> of EmailInboxs
   * @exception TorqueException
   *              if an error occurs
   */
   ...
   */
  protected boolean existsImpl(EmailInbox om) throws TorqueException {
    Criteria crit = EmailInboxPeer.buildCriteria(om);
  ...
  @Override
  protected List<EmailInbox> retrieveStoredOMs(List ids)
      throws TorqueException {
