 ...
 * @version $Id: JetspeedUserProfilePeer.java,v 1.14 2003/07/23 19:50:14
 *          morciuch Exp $
 */
public class JetspeedUserProfilePeer extends
    org.apache.jetspeed.om.dbpsml.BaseJetspeedUserProfilePeer implements
    DBOperations {
  ...
  /**
   * Select user profile record from the database table for the given locator
   * object.
   * 
   * @param locator
   ...
   */
  public List<JetspeedUserProfile> select(ProfileLocator locator,
      Connection connection) throws Exception {
   ...
   * @return List of records that statisfy the given locator criteria.
   */
  public List<JetspeedUserProfile> selectOrdered(ProfileLocator locator,
      Connection connection) throws Exception {
    Criteria criteria = buildCriteria(locator);
   ...
   * 
   * @param user
   *          User object for which all the records will be deleted from the
   *          database
   * @param connection
   *          A database connection to use
   */
