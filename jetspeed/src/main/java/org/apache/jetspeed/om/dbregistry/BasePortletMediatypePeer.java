...
// Local classes
import org.apache.jetspeed.om.dbregistry.map.PortletMediatypeMapBuilder;
 ...
 * 
 */
public abstract class BasePortletMediatypePeer extends BasePeer {

  /** the default database name for this class */
  public static final String DATABASE_NAME = "default";

  /** the table name for this class */
  public static final String TABLE_NAME = "PORTLET_MEDIATYPE";
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(PortletMediatypeMapBuilder.CLASS_NAME);
  }
  ...
  static {
    ID = "PORTLET_MEDIATYPE.ID";
    MEDIA_ID = "PORTLET_MEDIATYPE.MEDIA_ID";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
      ...
      Torque.registerMapBuilder(PortletMediatypeMapBuilder.CLASS_NAME);
    }
  }
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BasePortletMediatypePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static PortletMediatype row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, PortletMediatype obj)
      throws TorqueException {
    try {
      obj.setId(row.getValue(offset + 0).asLong());
      obj.setMediaId(row.getValue(offset + 1).asLong());
    } catch (DataSetException e) {
      throw new TorqueException(e);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<PortletMediatype> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BasePortletMediatypePeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
  ...
  public static List<PortletMediatype> populateObjects(List<?> records)
      throws TorqueException {
    List<PortletMediatype> results =
      new ArrayList<PortletMediatype>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(PortletMediatypePeer.row2Object(row, 1, PortletMediatypePeer
        .getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BasePortletMediatypePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BasePortletMediatypePeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static void doInsert(PortletMediatype obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(PortletMediatype obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(PortletMediatype obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(PortletMediatype) method. It will take care of
   ...
   *           into a TorqueException.
   */
  public static void doInsert(PortletMediatype obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(PortletMediatype) method. It will take care of
   * the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(PortletMediatype obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(PortletMediatype) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(PortletMediatype obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BasePortletMediatypePeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(PortletMediatype obj) {
    Criteria criteria = new Criteria(DATABASE_NAME);
    criteria.add(ID, obj.getId());
    criteria.add(MEDIA_ID, obj.getMediaId());
    return criteria;
  }

  /**
   * selects a collection of PortletMediatype objects pre-filled with their
  ...
  protected static List<PortletMediatype> doSelectJoinPortletDbEntry(Criteria c)
    ...
    c.addJoin(PortletMediatypePeer.ID, PortletDbEntryPeer.ID);
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      PortletMediatype obj1 = PortletMediatypePeer.row2Object(row, 1, omClass);
      omClass = PortletDbEntryPeer.getOMClass();
      PortletDbEntry obj2 = PortletDbEntryPeer.row2Object(row, offset, omClass);

      boolean newObject = true;
      for (int j = 0; j < results.size(); j++) {
        PortletMediatype temp_obj1 = results.get(j);
        PortletDbEntry temp_obj2 = temp_obj1.getPortletDbEntry();
        if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey())) {
          newObject = false;
          temp_obj2.addPortletMediatype(obj1);
          break;
        }
      }
      if (newObject) {
        obj2.initPortletMediatypes();
        obj2.addPortletMediatype(obj1);
      }
      results.add(obj1);
    }
    return results;
  ...
  protected static List<PortletMediatype> doSelectJoinMediatype(Criteria c)
    ...
    c.addJoin(PortletMediatypePeer.MEDIA_ID, MediatypePeer.ID);
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      Mediatype obj2 = MediatypePeer.row2Object(row, offset, omClass);
