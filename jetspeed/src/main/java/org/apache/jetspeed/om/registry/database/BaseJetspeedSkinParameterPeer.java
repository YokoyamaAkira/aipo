 ...
 * @version $Id: BaseJetspeedSkinParameterPeer.java,v 1.3 2004/04/06 23:00:16
 *          morciuch Exp $
 */
public class BaseJetspeedSkinParameterPeer extends BasePeer {
  ...
  protected static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BaseJetspeedSkinParameterPeer.class.getName());
  ...
  public static void populateObject(Record row, int offset, Parameter obj)
    ...
    try {
      ...
      BaseMetaInfo baseMetaInfo =
        new BaseMetaInfo(row.getValue(offset + 6).asString(), row.getValue(
          offset + 7).asString(), row.getValue(offset + 8).asString());
  ...
  public static List<Parameter> populateObjects(List<?> records)
    ...
    for (int i = 0; i < records.size(); i++) {
      ...
      results.add(BaseJetspeedSkinParameterPeer.row2Object(
        row,
        1,
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> doSelect(BaseSkinEntry obj)
      throws TorqueException {
