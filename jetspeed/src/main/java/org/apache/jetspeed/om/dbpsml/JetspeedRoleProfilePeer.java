 ...
 * @version $Id: JetspeedRoleProfilePeer.java,v 1.13 2003/08/13 04:18:17 taylor
 *          Exp $
 */
public class JetspeedRoleProfilePeer extends
    org.apache.jetspeed.om.dbpsml.BaseJetspeedRoleProfilePeer implements
    DBOperations {
  ...
  /**
   * Select role profile record from the database table for the given locator
   * object.
   * 
   * @param locator
   ...
   */
  public List<JetspeedRoleProfile> select(ProfileLocator locator,
      Connection connection) throws Exception {
   ...
   * @return List of records that statisfy the given locator criteria.
   */
  public List<JetspeedRoleProfile> selectOrdered(ProfileLocator locator,
      Connection connection) throws Exception {
   ...
   * 
   * @param role
   *          Role object for which all the records will be deleted from the
   *          database
   * @param connection
   *          A database connection to use
   */
