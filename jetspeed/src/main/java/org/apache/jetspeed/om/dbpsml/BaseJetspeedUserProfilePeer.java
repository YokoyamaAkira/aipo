...
// Local classes
import org.apache.jetspeed.om.dbpsml.map.JetspeedUserProfileMapBuilder;
 ...
 * 
 */
public abstract class BaseJetspeedUserProfilePeer extends BasePeer {

  /** the default database name for this class */
  public static final String DATABASE_NAME = "default";

  /** the table name for this class */
  public static final String TABLE_NAME = "JETSPEED_USER_PROFILE";
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(JetspeedUserProfileMapBuilder.CLASS_NAME);
  }
  ...
  static {
    ...
    if (Torque.isInit()) {
      ...
      Torque.registerMapBuilder(JetspeedUserProfileMapBuilder.CLASS_NAME);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedUserProfile> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseJetspeedUserProfilePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static JetspeedUserProfile row2Object(Record row, int offset,
      Class<?> cls) throws TorqueException {
    try {
      JetspeedUserProfile obj = (JetspeedUserProfile) cls.newInstance();
      JetspeedUserProfilePeer.populateObject(row, offset, obj);
  ...
  public static void populateObject(Record row, int offset,
      JetspeedUserProfile obj) throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedUserProfile> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseJetspeedUserProfilePeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedUserProfile> populateObjects(List<?> records)
      throws TorqueException {
    List<JetspeedUserProfile> results =
      new ArrayList<JetspeedUserProfile>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(JetspeedUserProfilePeer.row2Object(
        row,
        1,
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseJetspeedUserProfilePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseJetspeedUserProfilePeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedUserProfile> doSelect(JetspeedUserProfile obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doInsert(JetspeedUserProfile obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(JetspeedUserProfile obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(JetspeedUserProfile obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(JetspeedUserProfile) method. It will take care
   ...
   *           into a TorqueException.
   */
  public static void doInsert(JetspeedUserProfile obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(JetspeedUserProfile) method. It will take care
   * of the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(JetspeedUserProfile obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(JetspeedUserProfile) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(JetspeedUserProfile obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseJetspeedUserProfilePeer.doDelete(pk, (Connection) null);
  }
   ...
   *           Primary key was not found in database.
   */
  public static JetspeedUserProfile retrieveByPK(int pk)
   ...
   *           Primary key was not found in database.
   */
  public static JetspeedUserProfile retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Criteria criteria = buildCriteria(pk);
    List<JetspeedUserProfile> v = doSelect(criteria, con);
    if (v.size() == 0) {
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedUserProfile> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<JetspeedUserProfile> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
  ...
  public static List<JetspeedUserProfile> retrieveByPKs(List<?> pks,
    ...
    List<JetspeedUserProfile> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<JetspeedUserProfile>();
    } else {
      Criteria criteria = new Criteria();
