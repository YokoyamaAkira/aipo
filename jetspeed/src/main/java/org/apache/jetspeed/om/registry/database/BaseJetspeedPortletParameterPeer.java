 ...
 * @version $Id: BaseJetspeedPortletParameterPeer.java,v 1.3 2004/04/06 23:00:16
 *          morciuch Exp $
 */
public class BaseJetspeedPortletParameterPeer extends BasePeer {

  /**
   * Static initialization of the logger for this class
   */
  protected static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BaseJetspeedPortletParameterPeer.class.getName());
  ...
  public static final String CACHEDONNAME;

  /** the column name for the CACHEDONURL field */
  public static final String CACHEDONVALUE;
  ...
  static {
    ID = "PORTLET_PARAMETER.ID";
    NAME = "PORTLET_PARAMETER.NAME";
    VALUE = "PORTLET_PARAMETER.VALUE";
    HIDDEN = "PORTLET_PARAMETER.HIDDEN";
    TYPE = "PORTLET_PARAMETER.TYPE";
    CACHEDONNAME = "PORTLET_PARAMETER.CACHEDONNAME";
    CACHEDONVALUE = "PORTLET_PARAMETER.CACHEDONVALUE";
    ROLE = "PORTLET_PARAMETER.ROLE";
    TITLE = "PORTLET_PARAMETER.TITLE";
    DESCRIPTION = "PORTLET_PARAMETER.DESCRIPTION";
    IMAGE = "PORTLET_PARAMETER.IMAGE";
    PORTLET_ID = "PORTLET_PARAMETER.PORTLET_ID";
    /*
     * if (Torque.isInit()) { try { getMapBuilder(); } catch (Exception e) {
  ...
  private static Class<?> initClass(String className) {
    ...
    try {
      ...
      logger.error("A FATAL ERROR has occurred which should not "
   ...
   */
  public static List<Parameter> resultSet2Objects(java.sql.ResultSet results)
      throws TorqueException {
    try {
  ...
  public static void addSelectColumns(Criteria criteria) throws TorqueException {
    ...
    criteria.addSelectColumn(CACHEDONNAME);
    criteria.addSelectColumn(CACHEDONVALUE);
  ...
  public static void populateObject(Record row, int offset, Parameter obj)
    ...
    try {
      ...
      BaseMetaInfo baseMetaInfo =
        new BaseMetaInfo(row.getValue(offset + 8).asString(), row.getValue(
          offset + 9).asString(), row.getValue(offset + 10).asString());
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> doSelect(Criteria criteria)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> doSelect(Criteria criteria, Connection con)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> populateObjects(List<?> records)
      throws TorqueException {
    List<Parameter> results = new ArrayList<Parameter>(records.size());
    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(BaseJetspeedPortletParameterPeer.row2Object(
        row,
        1,
        BaseJetspeedPortletParameterPeer.getOMClass()));
    }
    return results;
  }
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> doSelect(BasePortletEntry obj)
      throws TorqueException {
  ...
  public static Criteria buildCriteria(BasePortletEntry obj) {
    ...
    /*
     * if (!obj.isNew()) criteria.add(PSML_ID, obj.getPsmlId());
     * criteria.add(USER_NAME, obj.getUserName()); criteria.add(MEDIA_TYPE,
     * obj.getMediaType()); criteria.add(LANGUAGE, obj.getLanguage());
     * criteria.add(COUNTRY, obj.getCountry()); criteria.add(PAGE,
     * obj.getPage()); criteria.add(PROFILE, obj.getProfile());
     */
    return criteria;
  }
  ...
  public static Parameter retrieveByPK(ObjectKey pk, Connection con)
    ...
    List<Parameter> v = doSelect(criteria, con);
    if (v.size() != 1) {
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
    List<Parameter> retVal = null;
    try {
      db = Torque.getConnection(DATABASE_NAME);
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> retrieveByPKs(List<?> pks, Connection dbcon)
      throws TorqueException {
    List<Parameter> objs = null;
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<Parameter>();
    } else {
      Criteria criteria = new Criteria();
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> retrieveById(int pk) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> retrieveById(ObjectKey pk)
      throws TorqueException {
    Connection db = null;
    List<Parameter> retVal = null;
    try {
   ...
   *           into a TorqueException.
   */
  public static List<Parameter> retrieveById(ObjectKey pk, Connection con)
      throws TorqueException {
    Criteria criteria = buildCriteria(pk);
