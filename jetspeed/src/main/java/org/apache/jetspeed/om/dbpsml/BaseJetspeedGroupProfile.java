 ...
 * references should be to JetspeedGroupProfile
 */
public abstract class BaseJetspeedGroupProfile extends BaseObject {
  /** The Peer class */
  private static final JetspeedGroupProfilePeer peer =
    new JetspeedGroupProfilePeer();
  ...
  public void save() throws Exception {
    save(JetspeedGroupProfilePeer.getMapBuilder().getDatabaseMap().getName());
  }
   ...
   */
  public JetspeedGroupProfile copy() throws TorqueException {
   ...
   */
  public JetspeedGroupProfilePeer getPeer() {
    return peer;
  }
}
