 ...
 * references should be to TurbineUser
 */
public abstract class BaseTurbineUser extends BaseObject {
  ...
  public void setUserId(int v) throws TorqueException {
    ...
    if (collTurbineUserGroupRoles != null) {
      for (int i = 0; i < collTurbineUserGroupRoles.size(); i++) {
        collTurbineUserGroupRoles.get(i).setUserId(v);
      }
    }
  }
   ...
   * it returns the collection. Otherwise if this TurbineUser has previously
   * been saved, it will retrieve related TurbineUserGroupRoles from storage. If
   * this TurbineUser is new, it will return an empty collection or the current
  ...
  /**
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this TurbineUser is new, it will
   * return an empty collection; or if this TurbineUser has previously been
   ...
   */
  @Override
  public void setPrimaryKey(ObjectKey userId) throws TorqueException {
  ...
  public TurbineUser copy() throws TorqueException {
    ...
    for (int i = 0; i < v.size(); i++) {
      TurbineUserGroupRole obj = v.get(i);
