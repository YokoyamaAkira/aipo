 ...
 * references should be to TurbineRole
 */
public abstract class BaseTurbineRole extends BaseObject {
  ...
  public void setRoleId(int v) throws TorqueException {
    ...
    if (collTurbineRolePermissions != null) {
      for (int i = 0; i < collTurbineRolePermissions.size(); i++) {
        collTurbineRolePermissions.get(i).setRoleId(v);
      }
    }
    ...
    if (collTurbineUserGroupRoles != null) {
      for (int i = 0; i < collTurbineUserGroupRoles.size(); i++) {
        collTurbineUserGroupRoles.get(i).setRoleId(v);
      }
    }
  }
  ...
  /**
   * Temporary storage of collTurbineRolePermissions to save a possible db hit
   * in the event objects are add to the collection, but the complete collection
   * is never requested.
   */
   ...
   * 
   * @param TurbineRolePermission
   *          l
   */
  public void addTurbineRolePermission(TurbineRolePermission l)
   ...
   * Otherwise returns the results of getTurbineRolePermissions(new Criteria())
   */
   ...
   * it returns the collection. Otherwise if this TurbineRole has previously
   * been saved, it will retrieve related TurbineRolePermissions from storage.
   * If this TurbineRole is new, it will return an empty collection or the
   * current collection, the criteria is ignored on a new object.
   */
  public List<TurbineRolePermission> getTurbineRolePermissions(Criteria criteria)
      throws TorqueException {
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        collTurbineRolePermissions = new ArrayList<TurbineRolePermission>();
        ...
        collTurbineRolePermissions =
          TurbineRolePermissionPeer.doSelect(criteria);
      }
    } else {
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getTurbineRolePermissions(new
   ...
   * taken as input
   */
  public List<TurbineRolePermission> getTurbineRolePermissions(Connection con)
      throws TorqueException {
    if (collTurbineRolePermissions == null) {
      collTurbineRolePermissions =
        getTurbineRolePermissions(new Criteria(10), con);
    }
    return collTurbineRolePermissions;
  }
  ...
  public List<TurbineRolePermission> getTurbineRolePermissions(
    ...
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        ...
        criteria.add(TurbineRolePermissionPeer.ROLE_ID, getRoleId());
        collTurbineRolePermissions =
          TurbineRolePermissionPeer.doSelect(criteria, con);
      }
    } else {
      // criteria has no effect for a new object
      if (!isNew()) {
  ...
  /**
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this TurbineRole is new, it will
   * return an empty collection; or if this TurbineRole has previously been
   * saved, it will retrieve related TurbineRolePermissions from storage.
   * 
   ...
   * TurbineRole.
   */
  protected List<TurbineRolePermission> getTurbineRolePermissionsJoinTurbineRole(
    ...
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        ...
        criteria.add(TurbineRolePermissionPeer.ROLE_ID, getRoleId());
        collTurbineRolePermissions =
          TurbineRolePermissionPeer.doSelectJoinTurbineRole(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
   ...
   * TurbineRole.
   */
  protected List<TurbineRolePermission> getTurbineRolePermissionsJoinTurbinePermission(
      Criteria criteria) throws TorqueException {
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        collTurbineRolePermissions = new ArrayList<TurbineRolePermission>();
        ...
        criteria.add(TurbineRolePermissionPeer.ROLE_ID, getRoleId());
        collTurbineRolePermissions =
          TurbineRolePermissionPeer.doSelectJoinTurbinePermission(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
   ...
   * the event objects are add to the collection, but the complete collection is
   * never requested.
   */
   ...
   * 
   * @param TurbineUserGroupRole
   *          l
   */
  public void addTurbineUserGroupRole(TurbineUserGroupRole l)
      throws TorqueException {
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getTurbineUserGroupRoles(new Criteria())
   */
   ...
   * If this collection has already been initialized with an identical criteria,
   * it returns the collection. Otherwise if this TurbineRole has previously
   * been saved, it will retrieve related TurbineUserGroupRoles from storage. If
   * this TurbineRole is new, it will return an empty collection or the current
   * collection, the criteria is ignored on a new object.
   */
  public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria)
      throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<TurbineUserGroupRole>();
      ...
      if (!isNew()) {
        ...
        if (!lastTurbineUserGroupRolesCriteria.equals(criteria)) {
          collTurbineUserGroupRoles =
            TurbineUserGroupRolePeer.doSelect(criteria);
        }
      }
    }
  ...
  /**
   * If this collection has already been initialized, returns the collection.
   * Otherwise returns the results of getTurbineUserGroupRoles(new
   * Criteria(),Connection) This method takes in the Connection also as input so
   * that referenced objects can also be obtained using a Connection that is
   * taken as input
   */
  public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Connection con)
      throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      collTurbineUserGroupRoles =
        getTurbineUserGroupRoles(new Criteria(10), con);
    }
    return collTurbineUserGroupRoles;
  }
  ...
  public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria,
    ...
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        ...
        criteria.add(TurbineUserGroupRolePeer.ROLE_ID, getRoleId());
        collTurbineUserGroupRoles =
          TurbineUserGroupRolePeer.doSelect(criteria, con);
      }
    } else {
      // criteria has no effect for a new object
      if (!isNew()) {
   ...
   * it returns the collection. Otherwise if this TurbineRole is new, it will
   * return an empty collection; or if this TurbineRole has previously been
   * saved, it will retrieve related TurbineUserGroupRoles from storage.
   * 
   * This method is protected by default in order to keep the public api
   * reasonable. You can provide public methods for those you actually need in
   * TurbineRole.
   */
  protected List<TurbineUserGroupRole> getTurbineUserGroupRolesJoinTurbineUser(
      Criteria criteria) throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<TurbineUserGroupRole>();
        ...
        criteria.add(TurbineUserGroupRolePeer.ROLE_ID, getRoleId());
        collTurbineUserGroupRoles =
          TurbineUserGroupRolePeer.doSelectJoinTurbineUser(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
   ...
   * TurbineRole.
   */
  protected List<TurbineUserGroupRole> getTurbineUserGroupRolesJoinTurbineGroup(
      Criteria criteria) throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<TurbineUserGroupRole>();
        ...
        criteria.add(TurbineUserGroupRolePeer.ROLE_ID, getRoleId());
        collTurbineUserGroupRoles =
          TurbineUserGroupRolePeer.doSelectJoinTurbineGroup(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
   ...
   * TurbineRole.
   */
  protected List<TurbineUserGroupRole> getTurbineUserGroupRolesJoinTurbineRole(
      Criteria criteria) throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<TurbineUserGroupRole>();
        ...
        criteria.add(TurbineUserGroupRolePeer.ROLE_ID, getRoleId());
        collTurbineUserGroupRoles =
          TurbineUserGroupRolePeer.doSelectJoinTurbineRole(criteria);
      }
    } else {
      // the following code is to determine if a new query is
      // called for. If the criteria is the same as the last
  ...
  public void save(Connection con) throws TorqueException {
    if (!alreadyInSave) {
      ...
      if (collTurbineRolePermissions != null) {
        for (int i = 0; i < collTurbineRolePermissions.size(); i++) {
          collTurbineRolePermissions.get(i).save(con);
        }
      }

      if (collTurbineUserGroupRoles != null) {
        for (int i = 0; i < collTurbineUserGroupRoles.size(); i++) {
          collTurbineUserGroupRoles.get(i).save(con);
        }
      }
      alreadyInSave = false;
    }
   ...
   */
  @Override
  public void setPrimaryKey(ObjectKey roleId) throws TorqueException {
  ...
  public TurbineRole copy() throws TorqueException {
    TurbineRole copyObj = new TurbineRole();
