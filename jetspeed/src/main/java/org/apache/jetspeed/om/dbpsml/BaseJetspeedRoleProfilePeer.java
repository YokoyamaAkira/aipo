...
// Local classes
import org.apache.jetspeed.om.dbpsml.map.JetspeedRoleProfileMapBuilder;
 ...
 * 
 */
public abstract class BaseJetspeedRoleProfilePeer extends BasePeer {

  /** the default database name for this class */
  public static final String DATABASE_NAME = "default";

  /** the table name for this class */
  public static final String TABLE_NAME = "JETSPEED_ROLE_PROFILE";
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(JetspeedRoleProfileMapBuilder.CLASS_NAME);
  }
  ...
  static {
    PSML_ID = "JETSPEED_ROLE_PROFILE.PSML_ID";
    ROLE_NAME = "JETSPEED_ROLE_PROFILE.ROLE_NAME";
    MEDIA_TYPE = "JETSPEED_ROLE_PROFILE.MEDIA_TYPE";
    LANGUAGE = "JETSPEED_ROLE_PROFILE.LANGUAGE";
    COUNTRY = "JETSPEED_ROLE_PROFILE.COUNTRY";
    PAGE = "JETSPEED_ROLE_PROFILE.PAGE";
    PROFILE = "JETSPEED_ROLE_PROFILE.PROFILE";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
      ...
      Torque.registerMapBuilder(JetspeedRoleProfileMapBuilder.CLASS_NAME);
    }
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedRoleProfile> resultSet2Objects(
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseJetspeedRoleProfilePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static JetspeedRoleProfile row2Object(Record row, int offset,
  ...
  public static void populateObject(Record row, int offset,
      JetspeedRoleProfile obj) throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedRoleProfile> doSelect(Criteria criteria)
      throws TorqueException {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseJetspeedRoleProfilePeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
  ...
  public static List<JetspeedRoleProfile> populateObjects(List<?> records)
      throws TorqueException {
    List<JetspeedRoleProfile> results =
      new ArrayList<JetspeedRoleProfile>(records.size());

    // populate the object(s)
    for (int i = 0; i < records.size(); i++) {
      Record row = (Record) records.get(i);
      results.add(JetspeedRoleProfilePeer.row2Object(
        row,
        1,
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseJetspeedRoleProfilePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseJetspeedRoleProfilePeer.doDelete(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<JetspeedRoleProfile> doSelect(JetspeedRoleProfile obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doInsert(JetspeedRoleProfile obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(JetspeedRoleProfile obj) throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static void doDelete(JetspeedRoleProfile obj) throws TorqueException {
    doDelete(buildCriteria(obj));
  }

  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(JetspeedRoleProfile) method. It will take care
   ...
   *           into a TorqueException.
   */
  public static void doInsert(JetspeedRoleProfile obj, Connection con)
      throws TorqueException {
   ...
   * otherwise use the doUpdate(JetspeedRoleProfile) method. It will take care
   * of the connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   *           into a TorqueException.
   */
  public static void doUpdate(JetspeedRoleProfile obj, Connection con)
      throws TorqueException {
   ...
   * use the doDelete(JetspeedRoleProfile) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
   ...
   *           into a TorqueException.
   */
  public static void doDelete(JetspeedRoleProfile obj, Connection con)
      throws TorqueException {
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseJetspeedRoleProfilePeer.doDelete(pk, (Connection) null);
  }
   ...
   *           Primary key was not found in database.
   */
  public static JetspeedRoleProfile retrieveByPK(int pk)
   ...
   *           Primary key was not found in database.
   */
  public static JetspeedRoleProfile retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
