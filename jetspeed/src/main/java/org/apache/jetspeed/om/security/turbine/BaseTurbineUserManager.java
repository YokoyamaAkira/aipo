...
/**
 * This class manages TurbineUser objects. This class was autogenerated by
 * Torque on:
 *
 ...
 * references should be to TurbineUserManager
 */
public abstract class BaseTurbineUserManager extends AbstractBaseManager {
  ...
  public static TurbineUserManager getManager() {
    return (TurbineUserManager) Torque
      .getManager(
        TurbineUserManager.MANAGED_CLASS,
   ...
   *              if an error occurs
   */
  public static TurbineUser getInstance() throws TorqueException {
   ...
   *              if an error occurs
   */
  public static TurbineUser getInstance(ObjectKey id) throws TorqueException {
   ...
   *              if an error occurs
   */
  public static TurbineUser getInstance(int id) throws TorqueException {
  ...
  public static boolean exists(TurbineUser obj) throws TorqueException {
   ...
   *              if an error occurs
   */
  public BaseTurbineUserManager() throws TorqueException {
   ...
   */
  protected TurbineUser getInstanceImpl() throws TorqueException {
   ...
   */
  protected TurbineUser getInstanceImpl(ObjectKey id) throws TorqueException {
   ...
   *          <code>ObjectKey</code> value
   * @param fromCache
   *          if true, look for cached TurbineUsers before loading from storage.
   */
   ...
   */
  protected boolean existsImpl(TurbineUser om) throws TorqueException {
    Criteria crit = TurbineUserPeer.buildCriteria(om);
