 ...
 * references should be to PortletCategory
 */
public abstract class BasePortletCategory extends BaseObject {
  /** The Peer class */
  private static final PortletCategoryPeer peer = new PortletCategoryPeer();
  ...
  public void save() throws Exception {
    save(PortletCategoryPeer.getMapBuilder().getDatabaseMap().getName());
  }
