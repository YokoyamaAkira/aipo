...
public interface SecurityEntry {
   ...
   *
   * @param metaInfo
   *          New value of property metaInfo.
   */
   ...
   * @param String
   *          role The role that will receive access to this action.
   * @return boolean Whether or not the access was granted. Basically, a
   *         <code>false</code> means that this role already has specific
   *         access.
   */
   ...
   * @param String
   *          role name of role to verify access for
   * @return boolean whether or not the <code>role</code> has access to this
   *         specific action.
   */
   ...
   *          action The action we are granting access to.
   * @param String
   *          group The group that will receive access to this action.
   * @return boolean Whether or not the access was granted. Basically, a
   *         <code>false</code> means that this group already has specific
   *         access.
   */
   ...
   *          action name of action to check
   * @param String
   *          group name of group to verify access for
   * @return boolean whether or not the <code>group</code> has access to this
   *         specific action.
   */
  boolean allowsSpecificGroup(String action, String group);

  /**
   * Grants access for a specific action to a specific group role for this
   * SecurityEntry. This grants specific access ignores "*" action, if it
   * exists.
   *
   * @param String
   ...
   *          role The role that will receive access to this action.
   * @return boolean Whether or not the access was granted. Basically, a
   *         <code>false</code> means that this group role already has specific
   *         access.
   */
  boolean grantGroupRoleAccess(String action, String group, String role);

  /**
   * Checks whether a group role is specifically allowed to access the request
   * action This method ignores the "*" action and is here to play a maintenance
   * role.
   *
   * @param String
   *          action name of action to check
   ...
   *          group name of group to verify access for
   * @param String
   *          role name of group to verify access for
   * @return boolean whether or not the <code>group role</code> has access to
   *         this specific action.
   */
  boolean allowsSpecificGroupRole(String action, String group, String role);

  /**
   * Returns the SecurityAccess object for the <code>action</code> requested or
   ...
   * @param String
   *          action The action we want the access for.
   * @return SecurityAccess that is defined for this action or <code>null</code>
   *         if one is not <strong>specifically defined</strong>
   */
   ...
   *          action name of action to check
   * @param String
   *          user name of user to verify access for
   * @return boolean whether or not the <code>user</code> has access to this
   *         specific action.
   */
   ...
   *          action The action we are granting access to.
   * @param String
   *          user The user that will receive access to this action.
   * @return boolean Whether or not the access was granted. Basically, a
   *         <code>false</code> means that this role already has specific
   *         access.
   */
