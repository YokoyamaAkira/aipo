...
/**
 * The BasePortletInfoEntry is a bean like implementation of the
 * PortletInfoEntry interface suitable for Castor XML serialization
 *
...
public abstract class BasePortletInfoEntry extends BaseRegistryEntry {
  ...
  /**
   * Needed for Castor 0.8.11 XML serialization for retrieving the media type
   * names associated to this object
   */
  ...
  /**
   * This method recreates the media name index for quick retrieval by name.
   */
  ...
  public Map<String, ToolDescriptor> getToolMap() {
    Hashtable<String, ToolDescriptor> map =
      new Hashtable<String, ToolDescriptor>();
