...
// Local classes
import org.apache.jetspeed.om.security.turbine.map.TurbineUserMapBuilder;
...
public abstract class BaseTurbineUserPeer extends BasePeer {
  ...
  /** the column name for the PASSWORD_CHANGED field */
  public static final String PASSWORD_CHANGED;

  static {
    USER_ID = "TURBINE_USER.USER_ID";
    LOGIN_NAME = "TURBINE_USER.LOGIN_NAME";
    PASSWORD_VALUE = "TURBINE_USER.PASSWORD_VALUE";
    FIRST_NAME = "TURBINE_USER.FIRST_NAME";
    LAST_NAME = "TURBINE_USER.LAST_NAME";
    EMAIL = "TURBINE_USER.EMAIL";
    CONFIRM_VALUE = "TURBINE_USER.CONFIRM_VALUE";
    MODIFIED = "TURBINE_USER.MODIFIED";
    CREATED = "TURBINE_USER.CREATED";
    LAST_LOGIN = "TURBINE_USER.LAST_LOGIN";
    DISABLED = "TURBINE_USER.DISABLED";
    OBJECTDATA = "TURBINE_USER.OBJECTDATA";
    PASSWORD_CHANGED = "TURBINE_USER.PASSWORD_CHANGED";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
      ...
      Torque.registerMapBuilder(TurbineUserMapBuilder.CLASS_NAME);
    }
  }
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseTurbineUserPeer.doInsert(criteria, (Connection) null);
  }
  ...
  public static void addSelectColumns(Criteria criteria) throws TorqueException {
    ...
    criteria.addSelectColumn(DISABLED);
    criteria.addSelectColumn(OBJECTDATA);
    criteria.addSelectColumn(PASSWORD_CHANGED);
  }
   ...
   *           into a TorqueException.
   */
  public static TurbineUser row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, TurbineUser obj)
      throws TorqueException {
    try {
      obj.setUserId(row.getValue(offset + 0).asInt());
      obj.setLoginName(row.getValue(offset + 1).asString());
      obj.setPasswordValue(row.getValue(offset + 2).asString());
      ...
      obj.setConfirmValue(row.getValue(offset + 6).asString());
      obj.setModified(row.getValue(offset + 7).asUtilDate());
      obj.setCreated(row.getValue(offset + 8).asUtilDate());
      obj.setLastLogin(row.getValue(offset + 9).asUtilDate());
      obj.setDisabled(row.getValue(offset + 10).asString());
      obj.setObjectdata(row.getValue(offset + 11).asBytes());
      obj.setPasswordChanged(row.getValue(offset + 12).asUtilDate());
    } catch (DataSetException e) {
      throw new TorqueException(e);
    }
  }
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseTurbineUserPeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbineUser> populateObjects(List<?> records)
      throws TorqueException {
    ...
    for (int i = 0; i < records.size(); i++) {
      ...
      results.add(TurbineUserPeer.row2Object(row, 1, TurbineUserPeer
        .getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseTurbineUserPeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseTurbineUserPeer.doDelete(criteria, (Connection) null);
  }
  ...
  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(TurbineUser) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   ...
   * otherwise use the doUpdate(TurbineUser) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   * use the doDelete(TurbineUser) method. It will take care of the connection
   * details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseTurbineUserPeer.doDelete(pk, (Connection) null);
  }
  ...
  public static Criteria buildCriteria(TurbineUser obj) {
    ...
    criteria.add(CONFIRM_VALUE, obj.getConfirmValue());
    criteria.add(MODIFIED, obj.getModified());
    criteria.add(CREATED, obj.getCreated());
    criteria.add(LAST_LOGIN, obj.getLastLogin());
    criteria.add(DISABLED, obj.getDisabled());
    criteria.add(OBJECTDATA, obj.getObjectdata());
    criteria.add(PASSWORD_CHANGED, obj.getPasswordChanged());
    return criteria;
  }
   ...
   *           Primary key was not found in database.
   */
  public static TurbineUser retrieveByPK(int pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static TurbineUser retrieveByPK(ObjectKey pk) throws TorqueException,
      NoRowsException, TooManyRowsException {
    Connection db = null;
