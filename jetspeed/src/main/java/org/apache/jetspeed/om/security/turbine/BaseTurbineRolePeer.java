...
// Local classes
import org.apache.jetspeed.om.security.turbine.map.TurbineRoleMapBuilder;
 ...
 * 
 */
public abstract class BaseTurbineRolePeer extends BasePeer {

  /** the default database name for this class */
  public static final String DATABASE_NAME = "default";

  /** the table name for this class */
  public static final String TABLE_NAME = "TURBINE_ROLE";
  ...
  public static MapBuilder getMapBuilder() throws TorqueException {
    return getMapBuilder(TurbineRoleMapBuilder.CLASS_NAME);
  }
  ...
  static {
    ROLE_ID = "TURBINE_ROLE.ROLE_ID";
    ROLE_NAME = "TURBINE_ROLE.ROLE_NAME";
    OBJECTDATA = "TURBINE_ROLE.OBJECTDATA";
    if (Torque.isInit()) {
      try {
        getMapBuilder();
      } catch (Exception e) {
      ...
      Torque.registerMapBuilder(TurbineRoleMapBuilder.CLASS_NAME);
    }
  }
  ...
  public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
    return BaseTurbineRolePeer.doInsert(criteria, (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static TurbineRole row2Object(Record row, int offset, Class<?> cls)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static void populateObject(Record row, int offset, TurbineRole obj)
      throws TorqueException {
    try {
  ...
  public static List<?> doSelectVillageRecords(Criteria criteria)
      throws TorqueException {
    return BaseTurbineRolePeer.doSelectVillageRecords(
      criteria,
      (Connection) null);
  }
   ...
   *           into a TorqueException.
   */
  public static List<TurbineRole> populateObjects(List<?> records)
      throws TorqueException {
    ...
    for (int i = 0; i < records.size(); i++) {
      ...
      results.add(TurbineRolePeer.row2Object(row, 1, TurbineRolePeer
        .getOMClass()));
    }
    return results;
  }
  ...
  public static void doUpdate(Criteria criteria) throws TorqueException {
    BaseTurbineRolePeer.doUpdate(criteria, (Connection) null);
  }
  ...
  public static void doDelete(Criteria criteria) throws TorqueException {
    BaseTurbineRolePeer.doDelete(criteria, (Connection) null);
  }
  ...
  /**
   * Method to do inserts. This method is to be used during a transaction,
   * otherwise use the doInsert(TurbineRole) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   ...
   * otherwise use the doUpdate(TurbineRole) method. It will take care of the
   * connection details internally.
   * 
   * @param obj
   *          the data object to update in the database.
   ...
   * use the doDelete(TurbineRole) method. It will take care of the connection
   * details internally.
   * 
   * @param obj
   *          the data object to delete in the database.
  ...
  public static void doDelete(ObjectKey pk) throws TorqueException {
    BaseTurbineRolePeer.doDelete(pk, (Connection) null);
  }
   ...
   *           Primary key was not found in database.
   */
  public static TurbineRole retrieveByPK(int pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static TurbineRole retrieveByPK(ObjectKey pk) throws TorqueException,
      NoRowsException, TooManyRowsException {
    Connection db = null;
   ...
   *           into a TorqueException.
   */
  public static List<TurbineRole> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
   ...
   *           into a TorqueException.
   */
  public static List<TurbineRole> retrieveByPKs(List<?> pks, Connection dbcon)
      throws TorqueException {
