...
/**
 * The PortletInfoEntry defines all the common description properties for all
 * the portlet related entries.
 *
...
public interface PortletInfoEntry extends RegistryEntry {
  ...
  /**
   * Search for a named tool and return the associated ToolDescriptor. The
   * search is case sensitive.
   *
   * @return the ToolDescriptor for a given name
   * @param name
   *          the tool name to look for
   */
