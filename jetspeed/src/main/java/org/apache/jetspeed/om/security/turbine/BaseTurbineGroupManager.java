...
/**
 * This class manages TurbineGroup objects. This class was autogenerated by
 * Torque on:
 *
 ...
 * references should be to TurbineGroupManager
 */
public abstract class BaseTurbineGroupManager extends AbstractBaseManager {
  ...
  protected static String DEFAULT_MANAGER_CLASS =
    "org.apache.jetspeed.om.security.turbine.TurbineGroupManager";
  ...
  public static TurbineGroupManager getManager() {
    return (TurbineGroupManager) Torque
      .getManager(
        TurbineGroupManager.MANAGED_CLASS,
   ...
   *              if an error occurs
   */
  public static TurbineGroup getInstance(ObjectKey id, boolean fromCache)
   ...
   *              if an error occurs
   */
  public static TurbineGroup getInstance(int id, boolean fromCache)
      throws TorqueException {
   ...
   *          <code>ObjectKey</code> value
   * @param fromCache
   *          if true, look for cached TurbineGroups before loading from
   *          storage.
   */
  protected TurbineGroup getInstanceImpl(ObjectKey id, boolean fromCache)
      throws TorqueException {
  ...
  protected boolean existsImpl(TurbineGroup om) throws TorqueException {
    Criteria crit = TurbineGroupPeer.buildCriteria(om);
  ...
  @Override
  protected List<TurbineGroup> retrieveStoredOMs(List ids)
      throws TorqueException {
