...
/**
 * This class manages Mediatype objects. This class was autogenerated by Torque
 * on:
 *
 ...
 * references should be to MediatypeManager
 */
public abstract class BaseMediatypeManager extends AbstractBaseManager {
  ...
  public static MediatypeManager getManager() {
    return (MediatypeManager) Torque
      .getManager(
        MediatypeManager.MANAGED_CLASS,
   ...
   *              if an error occurs
   */
  public static Mediatype getInstance() throws TorqueException {
   ...
   *              if an error occurs
   */
  public static Mediatype getInstance(ObjectKey id) throws TorqueException {
   ...
   *              if an error occurs
   */
  public static Mediatype getInstance(long id) throws TorqueException {
  ...
  public static boolean exists(Mediatype obj) throws TorqueException {
   ...
   *              if an error occurs
   */
  public BaseMediatypeManager() throws TorqueException {
   ...
   */
  protected Mediatype getInstanceImpl() throws TorqueException {
    Mediatype obj = null;
    try {
   ...
   */
  protected Mediatype getInstanceImpl(ObjectKey id) throws TorqueException {
   ...
   *          <code>ObjectKey</code> value
   * @param fromCache
   *          if true, look for cached Mediatypes before loading from storage.
   */
   ...
   */
  protected boolean existsImpl(Mediatype om) throws TorqueException {
    Criteria crit = MediatypePeer.buildCriteria(om);
  ...
  @Override
  protected List<Mediatype> retrieveStoredOMs(List ids) throws TorqueException {
