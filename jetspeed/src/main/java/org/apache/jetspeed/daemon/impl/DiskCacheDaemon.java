...
/**
 * A daemon that takes all instances of the DiskCacheDaemon and makes sure that
 * any content entries get updated on a regular basis.
 * 
...
public class DiskCacheDaemon implements Daemon {
  ...
  // akr 警告を消すために追記
  private final RunData rundata = null;

  /**
   * Static initialization of the logger for this class
   */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(DiskCacheDaemon.class.getName());
