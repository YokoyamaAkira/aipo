...
/**
 * Manages pulling URLs from the BadURLManager, and if they are available,
 * removing them from the BadURLManager and placing them in the DiskCache.
 * 
...
public class BadURLManagerDaemon implements Daemon {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BadURLManagerDaemon.class.getName());
