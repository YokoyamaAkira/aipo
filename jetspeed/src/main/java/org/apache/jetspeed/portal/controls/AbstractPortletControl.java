 ...
 * and also as the window manager for the enclosed Portlet(Set). As such it
 * controls the operation that may be performed on this portlet and whether the
 * portlet content should be displayed or not. PortletControl also delegates all
 * Portlet and PortletSet methods to its inner object and can thus be
 * transparently cascaded or substituted to a simple portlet wherever in a PSML
 * object tree.
 * 
 * @author <a href="mailto:raphael@apache.org">Rapha�l Luta</a>
 * @author <a href="mailto:sgala@apache.org">Santiago Gala</a>
 * @version $Id: AbstractPortletControl.java,v 1.22 2004/03/29 21:16:27 taylor
 *          Exp $
 */
public abstract class AbstractPortletControl extends AbstractPortlet implements
    PortletControl {
   ...
   * 
   * @param conf
   *          the new PortletControl configuration
   */
  @Override
   ...
   * 
   * @param portlet
   *          the new portlet to be managed by the control
   */
  @Override
   ...
   * 
   * @param portlet
   *          the portlet to be managed by this control
   */
  @Override
   ...
   * 
   * This method is deprecated and is only useful for ECS based Control
   * implementation
   * 
   * @deprecated
  ...
  /**
   * Returns the width of the managed portlet relative to the size of portlet
   * control. This method is deprecated and is only useful for ECS based Control
   * implementation
   * 
   * @deprecated
  ...
  /**
   * Sets the width of the managed portlet relative to the size of portlet
   * control.
   * 
   * This method is deprecated and is only useful for ECS based Control
   * implementation
   ...
   * @deprecated
   * @param width
   *          the width of portlet. Must be a positive, non nul integer
   */
  @Deprecated
  @Override
   ...
   * @deprecated
   * @param width
   *          the width of portlet. Must be parseable as a positive, non nul
   ...
   * 
   * @param title
   *          the new portlet title
   */
  @Override
  public void setTitle(String title) {
    if (getPortlet() != null) {
      getPortlet().setTitle(title);
    }
  }
   ...
   * 
   * @param description
   *          the new portlet description
   */
  @Override
  public void setDescription(String description) {
    if (getPortlet() != null) {
      getPortlet().setDescription(description);
    }
  }
  ...
  /**
   * @return the size of the inner portletSet, 1 if the inner portlet is not a
   *         set, or 0 if there's no inner portlet
   */
  @Override
  public int size() {
  ...
  /**
   * @return an array of portlet contained within the inner PortletSet or the
   *         inner portlet
   */
  @Override
  ...
  /**
   * Returns the Portlet at the given position if the control manages a
   * PortletSet, else the inner portlet if the queried position is 0
   * 
   * @param pos
   *          the queried position. Must be strictly smaller than the value of
   *          size()
  ...
  /**
   * Returns the elements contained within the inner PortletSet or the inner
   * portlet
   * 
   ...
   *          the portlet to add
   * @param position
   *          the position of the new portlet
   */
  @Override
   ...
   *          the portlet to add
   * @param constraints
   *          the portlet layout constraints
   */
  @Override
  public synchronized void addPortlet(Portlet portlet,
   ...
   *          the portlet layout constraints
   * @param position
   *          the portlet required position
   */
  @Override
  public synchronized void addPortlet(Portlet portlet,
      PortletSet.Constraints constraint, int position) {
    if (getPortlet() instanceof PortletSet) {
  ...
  /**
   * Sets the controller for the inner PortletSet. Has no effect if their is no
   * inner portletSet
   * 
  ...
  /**
   * Implements the default close behavior: any authenticated user may remove a
   * portlet from his page
   * 
   * @param rundata
  ...
  /**
   * Implements the default info behavior: any authenticated user may get
   * information on a portlet
   * 
   * @param rundata
   *          the RunData object for the current request
   */
  ...
  /**
   * Implements the default info behavior: any authenticated user may minimize a
   * portlet
   * 
   * @param rundata
   *          the RunData object for the current request
  ...
  /**
   * Implements the default info behavior: any authenticated user may display
   * portlet in print friendly format
   * 
   * @param rundata
   *          the RunData object for the current request
   */
