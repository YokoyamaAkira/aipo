...
/**
 * Preview portlet. Displays content of potlet defined in parameter
 * "previewedPortletName".
 *
...
public class PreviewPortlet extends AbstractPortlet {
  ...
  private static final JetspeedLogger logger =
    JetspeedLogFactoryService.getLogger(PreviewPortlet.class.getName());
  ...
  public ConcreteElement getContent(RunData rundata) {
    ...
    TurbineVelocity
      ...
      .put(
        "jetspeed",
        new org.apache.jetspeed.util.template.JetspeedTool(rundata));
    ...
    if (portletName == null) {
      ...
      try {
        ...
        rundata
          .setRedirectURI(
            jsLink
              .setUser(rundata.getUser().getUserName(), "default.psml")
      ...
      // return new JetspeedClearElement("You must specify portlet to preview
      // using [previewedPortletName] parameter");
    }
    ...
    try {
      ...
      if (result != null && !result.toString().equals("")) {
        /*
         * String html = result.toString(); String currentURL =
         * rundata.getRequest().getRequestURI();
         * Log.debug("PreviewPortlet: currentURL = " + currentURL +
         * " reader value = " + html); PreviewRewriter rewriter = new
         * PreviewRewriter(currentURL, currentURL , currentURL, portletName);
         * result = new JetspeedClearElement(rewriter.rewrite(new
         * StringReader(html)));
         */
      } else {
      ...
      logger.error("Exception", e);
      result =
        new JetspeedClearElement("This resource is temporarily unavailable");
    }
