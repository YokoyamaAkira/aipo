 ...
 * </P>
 * <UL>
 * <LI>source - The target of the IFRAME, where it grabs it's content from. Can
 * use ${webappRoot}. Default is "http://127.0.0.1"</LI>
 ...
 * Default is null.</LI>
 * <LI>scrolling - How to display a scrollbar. Default is "auto", to let the
 * browser decide.</LI>
 * <LI>frameborder - Whether or not to display a border around the IFRAME.
 * Default is 1 (yes).</LI>
 * <LI> <code>refresh</code> - value in seconds to auto refresh contents of the
 * IFRAME.</LI>
 * <LI> <code>align</code> - top | bottom | middle | left | <i>right</i> - How to
 * align the IFRAME in relation to surrounding content.</LI>
 * <LI> <code>marginwidth</code> - size of the top and bottom margin inside the
 * iframe.</LI>
 * <LI> <code>marginheight</code> - size of the left and right margin inside the
 * iframe.</LI>
 * </UL>
 * 
...
public class IFramePortlet extends AbstractInstancePortlet {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(IFramePortlet.class.getName());
  ...
  /**
   * Sets the name of iframe. This is useful when referencing the iframe as a
   * target from another link.
   * 
   * @param value
   */
  ...
  /**
   * Gets the message displayed when IFRAME is not supported This includes when
   * Frames are turned off.
   * 
