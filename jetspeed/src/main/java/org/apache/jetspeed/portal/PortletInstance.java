...
/**
 * This interface provides an easy, object-oriented approach to modifing a
 * portlet instance's persistent attributes. It provides methods for getting,
 * setting and removing attributes from portlet instance persistence storage.
 * 
...
public interface PortletInstance {
  /**
   * Retrieves an attributes value associated with a named object from a portlet
   * instance's persistence storage.
   * 
   * @param name
  ...
  /**
   * Retrieves a list of all of the attributes of this portlet instance as
   * <code>org.apache.jetspeed.om.profile.Parameter</code> objects.
   * 
  ...
  /**
   * Retrieves a list of all attributes names for all the attributes contained
   * within this portlet instance.
   * 
   * @return java.util.Iterator
   */
  ...
  /**
   * Retrieves the name of the parent portlet as it is defined within the
   * portlet registry.
   * 
  ...
  /**
   * Retrieves the title (if it is defined) of the parent portlet as it is
   * defined within the portlet registry.
   * 
  ...
  /**
   * Retrieves the description (if it is defined) of the parent portlet as it is
   * defined within the portlet registry.
   * 
