...
/**
 * The PortletSkin defines the color scheme to use for displaying a specified
 * portlet (and associated control)
 * 
...
public interface PortletSkin extends java.util.Map<String, String> {
  ...
  public static final String TAB_CONTENT_STYLE_CLASS =
  ...
  /**
   * Returns the CSS class to use on the control of the Highlighted titles on
   * tab or menu item
   * 
  ...
  /**
   * Returns a named image from this skin. The skin property must be prefixed
   * with "image-" within the registry.
   * 
   * @param String
   *          name name of image to retreive. <strong>DO NOT PREFIX WITH
   *          "image-"</strong> as getImage will do this for you.
   * @param String
   *          dftPath realtive path to a default image if the named one is not
   *          in the registry.
  ...
  /**
   * This returns the class to use for the entire portlet, based on the
   * cascading : portlet has 9 possible class to be used in a skin :
   * ________________ - title (+ left/right) |__|__________|__| | | | | | | | |
   * - content (+ left/right) | | | | | | | | |__|__________|__| - bottom (+
   * left/right) |__|__________|__|
   * 
