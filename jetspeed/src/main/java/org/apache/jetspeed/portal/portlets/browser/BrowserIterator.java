 ...
 * 
 */
public interface BrowserIterator extends Iterator<Object>, Comparator<Object>,
    Serializable {
   ...
   * vector. If it is called on the same columnName more than once it toggles
   * the ordering ie first it will be ascending, then it will be descending,
   * then ascending and so on.
   * 
   * @param String
   *          sortColumnName
   */
