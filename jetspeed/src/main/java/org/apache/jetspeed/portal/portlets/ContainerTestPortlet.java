                                                      ...
                                                      */
{
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ContainerTestPortlet.class.getName());
  ...
  /**
   * t a title for this instance of the portlet. This method is called from the
   * context variable portlet_instance and from PortletInstance
   * 
  ...
  public ConcreteElement getContent(RunData rundata) {
    String key =
      ((JetspeedRunData) rundata).getProfile().getId() + "." + this.getID();
  ...
  /**
   * All initialization should be performed here. If your Portlet wants to do
   * any work it should be done here. You are not guaranteed that any particular
   * order of method call will happen just that init() will happen first.
   * Therefore if you have to calculate things like a title, a description, etc
  ...
  /**
   * <p>
   * Return true if this portlet is allowed to be edited in the rundata's
   * context .
   * </p>
   * 
   * <p>
   * Note: PortletControl implementations should pay attention to this so that
   * they don't allow this option if it returns false.
   * </p>
   */
  @Override
