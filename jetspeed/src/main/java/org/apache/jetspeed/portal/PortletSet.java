...
public interface PortletSet extends Portlet {
   ...
   * Portlet within a Set. These constraints may be used by the
   * PortletController to render the layout of any given PortletSet correctly.
   */
  public interface Constraints extends Map<Object, Object> {
    /**
    ...
    /**
     * Set the column the portlet should be displayed in. This integer must be
     * positive
     * 
     * @param col
     *          the column position
    ...
    /**
     * Set the row the portlet should be displayed in. This integer must be
     * positive
     * 
     * @param row
     *          the column position
