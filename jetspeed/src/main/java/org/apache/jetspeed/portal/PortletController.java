...
/**
 * A PortletController is responsible for laying out and rendering the content
 * of a PortletSet.
 * <p>
...
public interface PortletController extends Serializable {
  ...
  /**
   * Initialize this PortletController. This method must be called after the
   * Config object has been set and whenever it is changed
   */
  public void init();
   ...
   * @return the rendered content for this set or null if the content was
   *         written directly on the writer available in RunData
   */
  public ConcreteElement getContent(RunData rundata);

  /**
   * Tests whether the controller supports outputting content for a specific
   * mime type
   * 
   * @param mimeType
