...
/**
 * Portlet to change RDF Site Summary into a portlet format for HTML
 * presentation.
 * 
...
public class RSSPortlet extends FileWatchPortlet {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(RSSPortlet.class.getName());
  ...
  public void init() throws PortletException {
    ...
    try {
      ...
      String stylesheet =
        this.getPortletConfig().getInitParameter("stylesheet");

      if (stylesheet == null) {
        throw new PortletException(
          "The 'stylesheet' parameter was not defined.");
      }

      try {
        // Set encoding for the document to utf-8...
        String content =
          SimpleTransform.transform(document, stylesheet, this
            .getPortletConfig()
            .getInitParameters());
      ...
      String message =
        "RSSPortlet:  Couldn't set items for XML document -> " + url;
