 ...
 * <code>WebPageService</code> interface
 * </P>
 * 
...
public class WebPageManager {
   ...
   */
  public static void get(HttpServlet servlet, HttpServletRequest request,
   ...
   */
  public static void post(HttpServlet servlet, HttpServletRequest request,
      HttpServletResponse response) throws ServletException, IOException {
