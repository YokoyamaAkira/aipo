...
public abstract class Search {
  ...
  protected static SearchService getService() {
    return (SearchService) TurbineServices.getInstance().getService(
   ...
   * @return
   */
  public static boolean remove(Collection<Object> c) {
   ...
   * @return
   */
  public static boolean add(Collection<Object> c) {
   ...
   * @return
   */
  public static boolean update(Collection<Object> c) {
