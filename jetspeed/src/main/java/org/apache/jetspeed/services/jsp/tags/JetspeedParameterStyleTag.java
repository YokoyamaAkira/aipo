...
/**
 * Supporting class for the parameter style tag. Sends a parameter rendered
 * using specific style to the output stream.
 * 
 ...
 * </UL>
 * <p>
 * Note: tag body may also contain parameter style options in format:
 * option1=value1;optionN=valueN. Check documentation for individual parameter
 * style to see what options are supported
 * </p>
 * <p>
 * Note: Use care when specifying style options in the tag body - the body is
 * not cleansed to remove embedded carriage returns and tabs.
 * </p>
 * Examples:
 * <UL>
 * <LI>
 * <code>&lt;jetspeed:parameterStyle name="portlet-list" style="RegistryEntryListBox"/&gt;</CODE>
 * <LI>
 * <code>&lt;jetspeed:parameterStyle name="skin-list" style="RegistryEntryListBox"&gt;registry=Skin&lt;/jetspeed:parameterStyle/&gt;</CODE>
 * <LI>
 * <code>&lt;jetspeed:parameterStyle name="control-list" style="RegistryEntryListBox" value="TabControl"&gt;registry=PortletControl&lt;/jetspeed:parameterStyle/&gt;</CODE>
 * </UL>
 * 
 * @author <a href="mailto:morciuch@apache.org">Mark Orciuch</a>
 * @version $Id: JetspeedParameterStyleTag.java,v 1.4 2004/02/23 03:59:40 jford
 *          Exp $
 */
public class JetspeedParameterStyleTag extends BodyTagSupport {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(JetspeedParameterStyleTag.class.getName());
  ...
  public int doEndTag() throws JspException {
    RunData data =
      (RunData) pageContext.getAttribute(
        JspService.RUNDATA,
    ...
    try {
      ...
      String body =
        this.getBodyContent() == null ? null : this
          .getBodyContent()
          .getString();
      ...
      // If portlet name is specified, it will be used to check security for the
      // parameter
      if (this.portlet != null) {
        // Retrieve registry entry and its parameter
        PortletEntry entry =
          (PortletEntry) Registry.getEntry(Registry.PORTLET, this.portlet);
