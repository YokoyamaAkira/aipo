 ...
 * @author <a href="mailto:massimiliano.dessi@gruppoatlantis.it">Dess�
 *         Massimiliano</a>
 * @author <a href="mailto:massimiliano.dessi@gruppoatlantis.com">Dess�
 *         Massimiliano</a>
...
public class CustomLocalizationTool implements ApplicationTool {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(CustomLocalizationTool.class.getName());
  ...
  /**
   * Gets localized key from the default bundle and the provided locale. Returns
   * <code>null</code> if the resource is missing.
   * 
   * @param key
   *          string to translate.
   * @param locale
   *          prefered locale for translation.
