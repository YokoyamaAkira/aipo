...
/**
 * This service now only functions as an interim implementation of Turbine's
 ...
 *          $
 */
public class JetspeedLoggingService extends TurbineBaseService implements
    LoggingService {
  /**
  ...
  /**
   * This is a log method with logLevel == DEBUG, printing is done by the
   * default logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == DEBUG, printing is done by the given
   * logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == INFO, printing is done by the default
   * logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == INFO, printing is done by the given
   * logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == WARN, printing is done by the default
   * logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == WARN, printing is done by the given
   * logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == ERROR, printing is done by the
   * default logger
   */
  @Override
  ...
  /**
   * This is a log method with logLevel == ERROR, printing is done by the given
   * logger
   */
  @Override
