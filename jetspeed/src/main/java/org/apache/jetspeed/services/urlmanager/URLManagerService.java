 ...
 * </p>
 * <strong>It should be extended to also provide access to their
 * contents</strong>
 * 
...
public interface URLManagerService extends Service {
   ...
   */
  public int STATUS_BAD = STATUS_UNREACHABLE
   ...
   * @return The port of the proxy (1-65535), or -1 if no port was specified (=
   *         use default)
   */
