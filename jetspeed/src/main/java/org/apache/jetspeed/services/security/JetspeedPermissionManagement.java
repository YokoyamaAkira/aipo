...
/**
 * <p>
 * The <code>PermissionManagement</code> interface describes contract between
 ...
 * @version $Id: JetspeedPermissionManagement.java,v 1.4 2004/02/23 03:58:11
 *          jford Exp $
 */
...
public abstract class JetspeedPermissionManagement {
  ...
  protected static PermissionManagement getService() {
    return (PermissionManagement) TurbineServices.getInstance().getService(
      PermissionManagement.SERVICE_NAME);
  }
