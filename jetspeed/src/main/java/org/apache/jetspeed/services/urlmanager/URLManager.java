...
/**
 * <p>
 * This is a static wrapper around the URLManagerService for easing access to
 * its functionalities
 * </p>
 * 
...
public class URLManager {
   ...
   */
  public static int STATUS_TEMPORARY_UNAVAILABLE =
    URLManagerService.STATUS_TEMPORARY_UNAVAILABLE;

  /**
   * @see URLManagerService#STATUS_CONTENT_ERROR
   */
  public static int STATUS_CONTENT_ERROR =
    URLManagerService.STATUS_CONTENT_ERROR;
  ...
  public static void register(String url) {
    URLManagerService ums =
      (URLManagerService) TurbineServices.getInstance().getService(
