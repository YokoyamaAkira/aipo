...
/**
 * The WebPage Service service interface definition. All implementations of an
 * WebPage Service must implement this interface.
 * 
 * Interface defines methods to control the WebPage service, to manage 0..n
 * sessions amongst 0..n sites.
 * 
...
interface WebPageService {
  ...
  /**
   * Returns a snapshot collection of all the sites managed by this Proxy
   * service.
   * 
