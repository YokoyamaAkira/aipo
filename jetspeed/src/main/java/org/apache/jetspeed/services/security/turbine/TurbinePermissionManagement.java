 ...
 * @version $Id: TurbinePermissionManagement.java,v 1.10 2004/02/23 03:54:49
 *          jford Exp $
 */

public class TurbinePermissionManagement extends TurbineBaseService implements
    PermissionManagement {
  /**
   * Static initialization of the logger for this class
   */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(TurbinePermissionManagement.class.getName());
  ...
  public Iterator<?> getPermissions(String rolename)
    ...
    try {
      ...
      if (rels.size() > 0) {
        perms = new HashMap<String, Object>(rels.size());
      } else {
  ...
  public void removePermission(String permissionName)
    ...
    try {
      ...
      if (cascadeDelete) {
        ...
        critRolePerm.add(TurbineRolePermissionPeer.PERMISSION_ID, permission
          .getId());
