...
/**
 * <p>
 * This service subclasses <code>TurbineResourceService</code> and provides
 * functionality for overriding properties in default resource files. This
 * override behavior is extended to non-string properties
 * </p>
 * 
 * <P>
 * To override properties:
 * <ul>
 * <li>Define your own property file containing properties you want to override
 * (for example, my.properties)</li>
 * <li>Add the following property in my.properties file:
 * <code>services.ResourceService.classname = org.apache.jetspeed.services.resources.JetspeedResourceService</code>
 * </li>
 ...
 * 
 * <P>
 * <B>Important note on overriding services.</B>Order of initializing services
 * may be important. Overriding a service may change this order. It is important
 * that services attempt to initialize dependent services in their early init
 * methods. For example, to make sure that ServletService is running, invoke the
 * following code:
 * 
 * <PRE>
 ...
 * 
 * <P>
 * Also, ${variable} substitution is extended to non-string properties. For
 * example, the following property references are valid:
 * 
 * <PRE>
 ...
 * 
 * @version $Id: JetspeedResourceService.java,v 1.8 2004/02/23 03:29:53 jford
 *          Exp $
 */
public class JetspeedResourceService extends TurbineResourceService {
  ...
  public boolean getBoolean(String name) {
    ...
    return new Boolean(interpolate(getConfiguration().getString(name)))
      .booleanValue();
  }
  ...
  public double getDouble(String name) {
    ...
    return new Double(interpolate(getConfiguration().getString(name)))
      .doubleValue();
  }
  ...
  public float getFloat(String name) {
    ...
    return new Float(interpolate(getConfiguration().getString(name)))
      .floatValue();
  }
  ...
  public int getInt(String name) {
    ...
    return new Integer(interpolate(getConfiguration().getString(name)))
      .intValue();
  }
  ...
  public long getLong(String name) {
    ...
    return new Long(interpolate(getConfiguration().getString(name)))
      .longValue();
  }
  ...
  public ResourceService getResources(String prefix) {
    ...
    try {
      ...
      System.err.println("Exception in init of JetspeedResourceService"
        + e.getMessage());
      e.printStackTrace();
    }
  ...
  /**
   * This method is called when the Service is initialized It provides a way to
   * override properties at runtime. To use 'runtime' time properties, define a
   * directory where you are keeping your 'runtime' parameters and pass it in as
   * a System Property named 'jetspeed.conf.dir'
   * 
   * This implementation will take the name of the web application (i.e.
   * 'jetspeed') and use it to find the name of a properties file. These
   * properties are merged with the
   * TurbineResources/JetspeedResources.properties Similarly, you can override
   * Torque properties by naming a file in your runtime directory as
   * ${webapp.name}_Torque.properties
   * 
   * Examples: jetspeed.conf.dir = /Users/sysadmin/conf
   * 
   * This directory contains two files: 1. jetspeed.properties - overrides
   * properties in JetspeedResources.properties and TurbineResources.properties
  ...
  public synchronized void init(ServletConfig config)
    ...
    try {
      ...
      StringBuffer msg =
        new StringBuffer("Error reading properties for appName: ");
      msg.append(appName);
