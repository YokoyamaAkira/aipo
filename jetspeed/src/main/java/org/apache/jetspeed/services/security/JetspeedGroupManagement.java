...
/**
 * <p>
 * The <code>GroupManagement</code> interface describes contract between the
 * portal and security provider required for Jetspeed Group Management. This
 * interface enables an application to be independent of the underlying group
 * management technology.
 * 
 * @author <a href="mailto:david@bluesunrise.com">David Sean Taylor</a>
 * @version $Id: JetspeedGroupManagement.java,v 1.5 2004/02/23 03:58:11 jford
 *          Exp $
 */
...
public abstract class JetspeedGroupManagement {
  ...
  protected static GroupManagement getService() {
    return (GroupManagement) TurbineServices.getInstance().getService(
      GroupManagement.SERVICE_NAME);
  }
  ...
  /**
   * Checks for the relationship of user has a group. Returns true when the user
   * has the given group.
   * 
   * The security service may optionally check the current user context to
   * determine if the requestor has permission to perform this action.
