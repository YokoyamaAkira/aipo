...
/**
 * 
 * WebPageConsoleServlet is the main servlet entry point for the WebPage
 * console.
 * 
 */
...
public class WebPageConsoleServlet extends VelocityServlet {
  ...
  public Template handleRequest(HttpServletRequest request,
    ...
    try {
      ...
      System.out.println("WebPageConsoleServlet : parse error for template "
        + pee);
  ...
  /**
   * Set the log file to be off of the webapp root, and will do the same with
   * the file loader paths
   * 
   * @param config
   *          The Servlet configuration.
   * @return The Properties collection of Velocity properties.
   * @throws exceptions
   *           when failed to read the properties or log files
   */
  @Override
  protected Properties loadConfiguration(ServletConfig config)
    ...
    /*
     * first, normalize our velocity log file to be in the webapp
     */
    ...
    /*
     * now, if there is a file loader resource path, treat it the same way.
     */
