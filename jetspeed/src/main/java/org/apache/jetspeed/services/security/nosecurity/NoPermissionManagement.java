...
/**
 * <p>
 * The <code>NoPermissionManagement</code> class is a Jetspeed security
 * provider, implementing the <code>PermissionManagement</code> interface. It
 * provides no permission management - no roles have permissions, no permissions
 * are saved, and requests for any permission is satisfied with a temp.
 * Permission object.
 * 
 ...
 *          $
 */
public class NoPermissionManagement extends TurbineBaseService implements
