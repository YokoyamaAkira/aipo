 ...
 * {@link org.apache.turbine.util.ParameterParser} as
 * {@link org.apache.turbine.util.upload.FileItem}s.
 * 
 * <p>
 * This implementation of
 * {@link org.apache.turbine.services.upload.UploadService} handles multiple
 * files per single html widget, sent using multipar/mixed encoding type, as
 * specified by RFC 1867. Use
 * {@link org.apache.turbine.util.ParameterParser#getFileItems(String)} to
 * acquire an array of {@link org.apache.turbine.util.upload.FileItem}s
 * associated with given html widget.
 * 
...
public class JetspeedUploadService extends TurbineUploadService {
  /**
   * <p>
   * Processes an <a href="http://rf.cx/rfc1867.html">RFC 1867</a> compliant
  ...
  public void parseRequest(HttpServletRequest req, ParameterParser params,
      String path) throws TurbineException {
    ...
    try {
      byte[] boundary =
        contentType.substring(contentType.indexOf("boundary=") + 9).getBytes();
      ...
      while (nextPart) {
        ...
        if (fieldName != null) {
          ...
          if (subContentType != null
            ...
            byte[] subBoundary =
              subContentType
                .substring(subContentType.indexOf("boundary=") + 9)
                .getBytes();
            ...
            while (nextSubPart) {
              ...
              if (getFileName(headers) != null) {
                FileItem item = createItem(path, headers, requestSize);
            ...
            if (getFileName(headers) != null) {
              ...
              params.append(getFieldName(headers), new String(item.get()));
            }
          }
        } else {
          // Skip this part.
      ...
      throw new TurbineException("Processing of "
        + MULTIPART_FORM_DATA
        + " request failed", e);
    }
