...
/**
 * Classes that implement the Logger interface allows loging. There is set of
 * standart printing methods (info, debug ...). This is a wrapper for the
 * commons Log object.
 * 
...
public class BaseLogger implements Logger {
  ...
  /**
   * This method should be implemented by user. It performs action that are need
   * for deterimne whether logger was well configured or has any output
   * 
  ...
  /**
   * This method sets parameters for the logger implementation. If the
   * implementation cannot handle some type of destination should ignore that
   * output.
   * 
   * @param LoggingConfig
