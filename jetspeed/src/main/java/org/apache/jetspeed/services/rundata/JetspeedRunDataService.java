...
/**
 * The JetspeedRunDataService extends TurbineRunDataService, adding the ability
 * to get the current runData object for the thread at any time. This is
 * accomplished by storing the active runData objects in a map, keyed by thread.
...
public class JetspeedRunDataService extends TurbineRunDataService {
   ...
   */
  @Override
  public RunData getRunData(String key, HttpServletRequest req,
      HttpServletResponse res, ServletConfig config) throws TurbineException,
      IllegalArgumentException {
    // let the super do the work
    JetspeedRunData r =
      (JetspeedRunData) super.getRunData(key, req, res, config);
