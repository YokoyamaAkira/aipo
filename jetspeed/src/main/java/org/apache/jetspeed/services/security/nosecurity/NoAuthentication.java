...
/**
 * <p>
 * The <code>NoAuthentication</code> class is a Jetspeed security provider,
 * implementing the <code>PortalAuthentication</code> interface. It provides no
 * authentication - all login attempts are allowed.
 * 
 ...
 */
public class NoAuthentication extends TurbineBaseService implements
  ...
  /**
   * Performs late initialization. Called just before the first use of the
   * service.
   * 
