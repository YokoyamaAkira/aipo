...
/**
 * <P>
 * This is the interface to the Jetspeed Forward services. The interface defines
 * methods for forwarding navigation to other pages or panes in the portal. The
 * Forward service provides an abstraction, by removing the hard-coding of
 * portal resources in your actions. Instead, all forward targets are defined in
