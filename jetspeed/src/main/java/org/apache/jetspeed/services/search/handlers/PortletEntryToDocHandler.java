 ...
 * @version $Id: PortletEntryToDocHandler.java,v 1.5 2004/02/23 03:47:46 jford
 *          Exp $
 */
public class PortletEntryToDocHandler extends RegistryEntryToDocHandler {
  ...
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(PortletEntryToDocHandler.class.getName());
  ...
  public ParsedObject parseObject(Object o) {
    ...
    // TODO: index the url for portlets defining one. A good candidate would be
    // HTML, Webpage
    // and IFrame portlets.
