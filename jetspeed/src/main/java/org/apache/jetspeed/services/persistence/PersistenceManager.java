...
/**
 * Static accessor to the Portal Persistence Service for storing and retrieving
 * portlet instances.
 * 
...
public abstract class PersistenceManager {
   ...
   * 
   * @param portlet
   *          The portlet to retrieve an instance for
   * @param data
   *          Request rundata.
   ...
   * @exception PortalPersistenceException
   *              if there were problems storing the PSMLDocument to persistent
   *              storage.
   * 
   */
