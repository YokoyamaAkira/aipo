...
/**
 * <p>
 * The <code>RoleManagement</code> interface describes contract between the
 * portal and security provider required for Jetspeed Role Management. This
 * interface enables an application to be independent of the underlying role
...
public interface RoleManagement extends Service {
   ...
   */
  Iterator<?> getRoles(String username) throws JetspeedSecurityException;
   ...
   *              when the requestor is denied due to insufficient privilege
   */
  void removeRole(String rolename) throws JetspeedSecurityException;
   ...
   *              when the requestor is denied due to insufficient privilege
   */
  Role getRole(String rolename) throws JetspeedSecurityException;
