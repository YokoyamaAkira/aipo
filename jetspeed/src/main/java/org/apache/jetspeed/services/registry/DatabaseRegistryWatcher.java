...
/**
 * Registry watcher for Database Registry service. Keeps any cached registry
 * entries refreshed with backend database.
 *
 * @author <a href="mailto:susinha@cisco.com">Suchisubhra Sinha</a>
 * @version $Id: DatabaseRegistryWatcher.java,v 1.2 2004/02/23 03:31:50 jford
 *          Exp $
 */
    ...
    synchronized (this) {
      if (subscriber != null) {
        ...
        while (en.hasMoreElements()) {
          try {
            subscriber.removeFragment((en.nextElement()));
          } catch (Exception e) {
      ...
      if (subscriber != null) {
        ...
        while (en.hasMoreElements()) {
          try {
            subscriber.loadFragment((en.nextElement()));
          } catch (Exception e) {
