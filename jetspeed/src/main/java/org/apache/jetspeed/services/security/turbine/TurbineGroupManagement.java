 ...
 * @version $Id: TurbineGroupManagement.java,v 1.11 2004/02/23 03:54:49 jford
 *          Exp $
 */

public class TurbineGroupManagement extends TurbineBaseService implements
    GroupManagement {
   ...
   * 
   * The security service can throw a <code>NotUniqueEntityException</code> when
   * the public credentials fail to meet the security provider-specific unique
   * constraints. The security service may optionally check the current user
   * context to determine if the requestor has permission to perform this
   * action.
   * 
   * @exception GroupException
   *              when the security provider has a general failure.
  ...
  /**
   * Unjoin a user from a group in which the user has a specific role instead of
   * <Code>JetspeedSecurity.getRole(defaultRole)</Code>
   * 
   * The security service may optionally check the current user context to
   * determine if the requestor has permission to perform this action.
   * 
