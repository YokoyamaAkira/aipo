...
/**
 * Bean like implementation of a multi-object registry usable by Castor XML
 * serialization
 *
 ...
 */
public class RegistryFragment extends Hashtable<Object, Object> implements
    java.io.Serializable {

  /**
   * this flag is used to mark this fragment has some changes that are not yet
   * persisted to disk
   */
  ...
  /**
   * Sets the dirty flag indicating wether this fragment has some uncommitted
   * changes
   *
   * @param value
   *          the new dirty state for this fragment
   */
  ...
  /**
   * Sets the changed flag indicating wether this fragment has some changes to
   * load
   *
   * @param value
   *          the new dirty state for this fragment
  ...
  /**
   * @return the entries stored in this Fragment that are suitable for the
   *         requested registry
   *
   * @param name
   *          a valid Registry name.
   */
  public Vector<String> getEntries(String name) {

    if (name != null) {
      @SuppressWarnings("unchecked")
      Vector<String> registry = (Vector<String>) get(name);
