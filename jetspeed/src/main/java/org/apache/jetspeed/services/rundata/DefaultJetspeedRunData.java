 ...
 *          Exp $
 */
public class DefaultJetspeedRunData extends DefaultTurbineRunData implements
    JetspeedRunData {
  /**
   * Static initialization of the logger for this class
   */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(DefaultJetspeedRunData.class.getName());
   ...
   * 
   * @param id
   *          the portlet id referenced in this request
   */
  @Override
  ...
  public Portlet getCustomized() {
    ...
    Stack<Portlet> stack =
      (Stack<Portlet>) customizationState.getAttribute("customize-stack");
   ...
   * 
   * @param id
   *          the portlet id to customize or null;
   */
  @Override
   ...
   * 
   * @param id
   *          the portlet id to maximize or null;
   */
  @Override
   ...
   * 
   * @param id
   *          the portlet id (PEID) referenced in this request
   */
  @Override
  ...
  /**
   * Get the user id for the current user. This method is provided as an
   * abstraction to the very implementation specific method of retrieving user
   * ids in Turbine.
   * 
  ...
  /**
   * Access an identifier for the current request's PageSession. A PageSession
   * is a specific portal page being viewed in a specific user session (and
   * perhaps, but not yet [@todo] in a specific browser window).
   * 
