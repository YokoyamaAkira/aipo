...
/**
 * <p>
 * The <code>NoGroupManagement</code> class is a Jetspeed security provider,
 * implementing the <code>GroupManagement</code> interface. It provides no group
 * management - no groups are listed, no groups are saved, no users are in any
 * groups, any request for a group is satisfied with a temporary Group object.
 * 
 ...
 */
public class NoGroupManagement extends TurbineBaseService implements
    GroupManagement {
  /**
   ...
   *              when the security provider has a general failure.
   */
  public HashMap<Object, Object> getTurbineGroupRole(String username)
      throws JetspeedSecurityException {
