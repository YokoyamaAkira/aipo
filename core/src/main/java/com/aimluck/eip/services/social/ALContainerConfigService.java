 ...
 * 
 */
public class ALContainerConfigService {

  private ALContainerConfigService() {
  ...
  public static String get(Property property) {
    return getService().getContainerConfig(property);
  }

  public static void put(Property property, String value) {
    getService().putContainerConfig(property, value);
  }
}
