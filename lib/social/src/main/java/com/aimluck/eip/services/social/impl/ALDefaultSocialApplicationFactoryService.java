 ...
 * 
 */
public class ALDefaultSocialApplicationFactoryService extends
   ...
   */
  @Override
  public ALSocialApplicationHandler getSocialApplicationHandler() {
    return ALDefaultSocialApplicationHanlder.getInstance();
  }
}
